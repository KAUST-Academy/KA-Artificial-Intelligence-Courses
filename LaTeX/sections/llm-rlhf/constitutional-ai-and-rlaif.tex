...
\begin{frame}[t,allowframebreaks]{What AI Feedback Does and Does Not Buy}
  \begin{itemize}\itemsep0.35em
    ...
    \item[\textcolor{red}{$\blacktriangleright$}] \textbf{Looking ahead:} the same machinery now drives reasoning-model post-training, where the ``labeler'' is a verifier rather than a preference model. That story, and the RL algorithms built for it (GRPO and GSPO), belongs to the RL post-training lecture later in the course.
  \end{itemize}
\end{frame}
