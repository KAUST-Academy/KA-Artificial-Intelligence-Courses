...
\begin{frame}[allowframebreaks]{Inflating 2D Networks to 3D (I3D)}
    \begin{itemize}
        ...
        \item Can use weights of 2D conv to initialize 3D conv: copy $K_t$ times along time and divide by $K_t$.
...
\framebreak
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textbf{Temporal Modeling}: Captures motion information effectively by reusing pre-trained 2D networks.
...
\framebreak
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth,height=0.82\textheight,keepaspectratio]{images/video/slide_36_1_img.jpg}
        \caption*{\tiny [Source: UMich EECS 498 (2022), Lecture 24: Videos, slide 78]}
    \end{figure}
\framebreak
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth,height=0.82\textheight,keepaspectratio]{images/video/slide_37_1_img.png}
        \caption*{\tiny [Source: UMich EECS 498 (2022), Lecture 24: Videos, slide 79]}
    \end{figure}
\end{frame}