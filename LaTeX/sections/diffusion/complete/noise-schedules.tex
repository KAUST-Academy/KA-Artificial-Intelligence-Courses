...
\begin{frame}{Noise Schedules}
    ...
    \begin{column}{0.55\textwidth}
        \begin{figure}
            ...
            \caption*{Comparison of linear and cosine noise schedules. {\scriptsize Nichol \& Dhariwal, \href{https://arxiv.org/abs/2102.09672}{Improved Denoising Diffusion Probabilistic Models}, ICML 2021, Fig.~4}}
        \end{figure}
    \end{column}
\end{columns}
\end{frame}