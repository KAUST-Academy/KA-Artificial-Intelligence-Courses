...
\newcommand{\binxuwSdCaption}{%
  {\scriptsize Binxu Wang, \href{https://binxuw.scholars.harvard.edu/sites/g/files/omnuum11221/files/binxuw/files/stable_diffusion_a_tutorial.pdf}{Stable Diffusion: A Tutorial (Harvard ML from Scratch)}.}%
}
...
\begin{frame}{Refresher: Convolutional Neural Network}
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.50\textwidth}
      \centering
      \includegraphics[width=\linewidth,height=0.72\textheight,keepaspectratio]{assets/New-Lecture-Stable_Diffusion/binxuw_sd_tutorial_slide26_content.png}\\[0.25em]
  \end{columns}
\end{frame}
...
\begin{frame}{U-Net: A Natural Architecture for Image-to-Image Functions}
    \centering
    \includegraphics[width=0.8\linewidth,height=0.6\textheight,keepaspectratio]{assets/New-Lecture-Stable_Diffusion/unet.png}
\end{frame}
...
\begin{frame}{Note: Add Time Dependency}
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.46\textwidth}
      \centering
      % Image (from slide) showing Conv tensor, add time embedding, Fourier features
      \includegraphics[width=0.96\linewidth,height=0.7\textheight,keepaspectratio]{images/stable-diffusion/add-time-dimension.png}
  \end{columns}
\end{frame}
...
\begin{frame}[allowframebreaks]{U-Net in Stable Diffusion}
  \begin{columns}[T,onlytextwidth]
    \column{0.44\textwidth}
      ...
      \includegraphics[width=0.99\linewidth,keepaspectratio]{assets/New-Lecture-Stable_Diffusion/attention.png}\\[0.25em]
...
\begin{frame}{How to Understand Prompts?: Language Model Refresher}
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.50\textwidth}
      \centering
      \includegraphics[width=\linewidth,height=0.72\textheight,keepaspectratio]{assets/New-Lecture-Stable_Diffusion/binxuw_sd_tutorial_slide34_content.png}\\[0.25em]
  \end{columns}
\end{frame}
...
\begin{frame}{Learning Word Vectors: GPT, BERT \& CLIP}
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.50\textwidth}
      \centering
      \includegraphics[width=\linewidth,height=0.72\textheight,keepaspectratio]{assets/New-Lecture-Stable_Diffusion/binxuw_sd_tutorial_slide35_content.png}\\[0.25em]
  \end{columns}
\end{frame}
...
\begin{frame}{Joint Representation for Vision and Language: CLIP}
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.50\textwidth}
      \centering
      \includegraphics[width=\linewidth,height=0.72\textheight,keepaspectratio]{assets/New-Lecture-Stable_Diffusion/binxuw_sd_tutorial_slide36_content.png}\\[0.25em]
      {\scriptsize
...
\begin{frame}{Choice of Text Encoding}
      \begin{itemize}
        \item Encoder in Stable Diffusion: pre-trained CLIP ViT-L/14 text encoder.
