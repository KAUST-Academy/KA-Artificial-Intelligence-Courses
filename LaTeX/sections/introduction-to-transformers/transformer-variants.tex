...
\begin{frame}{BERT -- Bidirectional Encoder}
  \begin{columns}
    ...
    \begin{column}{0.42\textwidth}
      ...
      \includegraphics[width=0.98\textwidth]{images/introduction-to-transformers/transformer_variant_encoder_only_highlighted.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{BERT -- Bidirectional Encoder}
  \begin{columns}
    ...
    \begin{column}{0.43\textwidth}
      ...
      \vspace{-0.5em}
      \includegraphics[width=\textwidth]{images/introduction-to-transformers/transformer_variant_encoder_only_alt_highlighted.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{GPT -- \textcolor{yellow}{\textbf{Generative}} Pretrained Transformer}
  \begin{columns}
    ...
    \begin{column}{0.38\textwidth}
      ...
      \vspace{0.5em}
      \includegraphics[width=0.98\textwidth]{images/introduction-to-transformers/transformer_variant_decoder_only_highlighted.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{GPT -- \textcolor{yellow}{\textbf{Generative}} Pretrained Transformer}
  \begin{columns}
    ...
    \begin{column}{0.35\textwidth}
      ...
      \vspace{0.5em}
      \includegraphics[width=\textwidth]{images/introduction-to-transformers/transformer_variant_decoder_only_alt_highlighted.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{The LLM Era -- Paradigm Shift in Machine Learning}
  \centering
  \includegraphics[width=0.8\paperwidth,height=0.8\paperheight,keepaspectratio]{images/introduction-to-transformers/transformer_variants_bert_gpt_t5_timeline.png}
\end{frame}
