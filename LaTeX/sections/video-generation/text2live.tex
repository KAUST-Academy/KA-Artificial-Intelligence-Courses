% --- Text2LIVE: text-driven video editing (relocated from the Learning-from-Videos deck) ---
...
\begin{frame}[allowframebreaks]{Text2LIVE}
    ...
    \begin{itemize}
        ...
        \item \textbf{CLIP supervision, zero-shot:} the edit layer is optimized so the result matches the text prompt under CLIP similarity; no paired training data or fine-tuning per video.
...
\framebreak
    ...
    \end{figure}
    {\footnotesize{[Text2LIVE: Text-Driven Layered Image and Video Editing, Bar-Tal, Ofri-Amar, Fridman et al., ECCV 2022]}}
\end{frame}
