% --- Recap / bridge from the SSL and JEPA lectures ---
\begin{frame}{Recap: From Pretraining Methods to Foundation Models}
  \begin{itemize}\itemsep0.3em
    \item \textbf{SSL and contrastive lectures:} pretext tasks, contrastive learning (SimCLR, MoCo), and self-distillation (BYOL, DINO, DINOv2) learn features from unlabeled data.
    \item \textbf{JEPA lecture:} latent prediction (I-JEPA, V-JEPA 2) trains encoders that serve many tasks from frozen features; V-JEPA 2 already behaves like a video foundation model.
