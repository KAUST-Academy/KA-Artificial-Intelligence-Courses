...
\framebreak
        ...
        \item \textbf{Pix2Pix:}
        \begin{itemize}
            \item cGAN framework for supervised, paired image-to-image translation.
            \item U-Net generator with a PatchGAN discriminator.
        \end{itemize}
        \item \textbf{CycleGAN:}
        \begin{itemize}
...
\input{sections/gan/complete/variants/deep_convolutional_gans}
\input{sections/gan/complete/variants/wasserstein_gans}
\input{sections/gan/complete/variants/conditional_gans}
\input{sections/gan/complete/variants/pix2pix}
\input{sections/gan/complete/variants/cyclegans}
\input{sections/gan/complete/variants/stylegans}