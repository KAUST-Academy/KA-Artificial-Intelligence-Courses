...
\begin{frame}{Documentation and the Hand-off to Governance}
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            ...
            \end{itemize}
            \vspace{0.09em}
            {\scriptsize The content and ethics of these documents are covered in depth in the
            \textbf{Responsible AI \& Model Interpretability} deck; here we only care that the pipeline
            \emph{produces and versions} them.}
        \end{column}
        \begin{column}{0.48\textwidth}
    ...
    \vspace{0.12em}
    {\scriptsize \textbf{Hand-off:} bias auditing, fairness definitions, interpretability and regulation are the
    subject of the \textbf{Responsible AI \& Model Interpretability} deck. MLOps supplies the
    \emph{mechanisms} --- lineage, prediction logs, versioned artifacts --- that make those obligations
