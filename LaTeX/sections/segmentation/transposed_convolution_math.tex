...
\begin{figure}
\centering
\includegraphics[width=1.0\textwidth,height=0.85\textheight,keepaspectratio]{images/segmentation/TConv.png}
\caption*{\scriptsize Stride 2. Source: ``What is Transposed Convolutional Layer?'', geeksforgeeks.org.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=1.0\textwidth,height=0.85\textheight,keepaspectratio]{images/segmentation/TConv2.png}
\caption*{\scriptsize Stride 1. Source: ``What is Transposed Convolutional Layer?'', geeksforgeeks.org.}
\end{figure}
\end{frame}
...
\begin{frame}[allowframebreaks]{Transposed Convolution Output Size Formula}
