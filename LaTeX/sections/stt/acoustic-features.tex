...
\begin{frame}{Simple HMM: Estimating climate from ice cream observations}
  \centering
  \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{images/stt/stt_mel_scale_curve.png}
\end{frame}
...
\begin{frame}{Audio Feature Extraction: MFCCs}
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      \centering
      \includegraphics[width=0.95\textwidth]{images/stt/stt_mel_filterbank.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Mel Filter Bank Processing}
  \centering
  \includegraphics[width=\textwidth,height=0.92\textheight,keepaspectratio]{images/stt/stt_mel_filterbank_spectrogram.png}
\end{frame}
...
\begin{frame}{Gaussian Mixtures for Acoustic Modeling}
  \centering
  \includegraphics[width=\textwidth,height=0.92\textheight,keepaspectratio]{images/stt/stt_gmm_gaussian_components.png}
\end{frame}

% --- Stanford CS224S lec9, slide 28 ---
\begin{frame}{GMMs}
  \centering
  \includegraphics[width=\textwidth,height=0.92\textheight,keepaspectratio]{images/stt/stt_gmm_likelihood_summary.png}
\end{frame}
