...
\begin{frame}[allowframebreaks]{DCGAN}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth,keepaspectratio]{images/gan/dcgan-architecture.png}
    ...
    \begin{itemize}
        ...
        \item Key architectural guidelines:
            \begin{itemize}
                ...
                \item Discriminator downsamples with strided convolutions (no pooling layers).
...
\begin{frame}[allowframebreaks]{DCGAN: Results}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth,keepaspectratio]{images/gan/dcgan-result-1.png}
    \end{figure}
    ...
    \begin{figure}
        \centering
        \includegraphics[height=0.7\textheight,keepaspectratio]{images/gan/dcgan-result-2.png}
    ...
    \begin{figure}
        \centering
        \includegraphics[height=0.7\textheight,keepaspectratio]{images/gan/dcgan-result-3.png}
        \caption*{[Radford et al 2016]}
    \end{figure}
    ...
    \begin{figure}
        \centering
        \includegraphics[height=0.7\textheight,keepaspectratio]{images/gan/dcgan-result-4.png}
        \caption*{[Radford et al 2016]}
    \end{figure}
    ...
    \begin{figure}
        \centering
        \includegraphics[height=0.7\textheight,keepaspectratio]{images/gan/dcgan-result-5.png}
        \caption*{[Radford et al 2016]}
    \end{figure}
    ...
    \begin{figure}
        \centering
        \includegraphics[height=0.7\textheight,keepaspectratio]{images/gan/dcgan-result-6.png}
        \caption*{[Radford et al 2016]}
    \end{figure}
    ...
    \begin{figure}
        \centering
        \includegraphics[height=0.7\textheight,keepaspectratio]{images/gan/dcgan-result-7.png}
        \caption*{[Radford et al 2016]}
    \end{figure}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth,keepaspectratio]{images/gan/dcgan-result-table.png}
        \caption*{[Radford et al 2016]}
    \end{figure}
\end{frame}