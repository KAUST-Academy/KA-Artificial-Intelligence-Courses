...
We continue on our quest for likelihood-based generative models.

So far, we have studied two different types of generative models:
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Variational Autoencoders}: $p_\theta(x) = \int_z p_\theta(x|z) p_\theta(z) \, dz$
    \begin{itemize}
