...
\begin{frame}{Direct vs.\ Indirect Prompt Injection}
  \begin{itemize}\itemsep0.5em
    \item[\textcolor{KAred}{$\blacktriangleright$}] \textbf{Prompt injection (Recap):} untrusted text overrides the developer's intended instructions and hijacks the model's output. We saw this for chatbots earlier in the course.
