...
\framebreak
    \begin{figure}
        \centering
        \includegraphics[width=1.0\textwidth,height=0.72\textheight,keepaspectratio]{images/segmentation/obj-tracking.png}
        \caption*{\scriptsize Comparison of three tracking approaches. Source: Danelljan, Bhat, Khan \& Felsberg, ``ATOM: Accurate Tracking by Overlap Maximization'', CVPR 2019, Fig.~1.}
    \end{figure}
\end{frame}