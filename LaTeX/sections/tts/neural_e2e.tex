...
\begin{frame}{2016--2021 Era: End-to-end Neural TTS (Tacotron)}
  \centering
  \includegraphics[width=0.98\textwidth,keepaspectratio]{images/tts/tts_tacotron_architecture.png}
...
\begin{frame}[allowframebreaks]{Beyond Autoregression: FastSpeech, HiFi-GAN, Glow-TTS, Diffusion Models}
  \begin{itemize}
...
%   \end{itemize}
%   \centering
%   \includegraphics[width=0.90\textwidth,keepaspectratio]{images/tts/tts_mel_spectrogram.png}
