...
\begin{frame}{Neural nets for acoustic modeling goes back to early speech}
  \centering
  \includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]{images/stt/stt_mlp_phone_train_recog.png}
\end{frame}
...
\begin{frame}
  ...
  \centering
  \includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]{images/stt/stt_tdnn_early_neural_asr.png}
\end{frame}
...
\begin{frame}{Hybrid systems took over ASR around 2012-2015}
  ...
  \end{itemize}
  \centering
  \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{images/stt/stt_dnn_hmm_wer_comparison.png}
\end{frame}
...
\begin{frame}{Recurrent DNN hybrid acoustic models}
  \centering
  \includegraphics[width=\textwidth,height=0.92\textheight,keepaspectratio]{images/stt/stt_dnn_hmm_hybrid_states.png}
\end{frame}

\begin{frame}{Deep recurrent networks}
  \centering
  \includegraphics[width=\textwidth,height=0.92\textheight,keepaspectratio]{images/stt/stt_rnn_recurrent_equations.png}
\end{frame}
