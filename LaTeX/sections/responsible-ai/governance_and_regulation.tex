...
\begin{frame}[allowframebreaks]{The EU AI Act: What a High-Risk Provider Must Produce}
    ...
    model obligations from 2 August 2025. The application dates for the high-risk (Annex I/III)
    obligations have been subject to amendment and remain in flux --- always check the consolidated
    text for the current timeline.}
\end{frame}
