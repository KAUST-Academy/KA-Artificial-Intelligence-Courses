...
% ---------------------------------------------------------------- Slide 4
\begin{frame}{In the past decade, systems and hardware have transformed ML. Now, it's time for ML to transform systems and hardware.}
\vfill
\begin{center}
\begin{tikzpicture}[font=\large]
    \node[draw, fill=sysblue, minimum width=3.4cm, minimum height=1.5cm] (sys) {Systems};
...
\centering
\includegraphics[width=\linewidth,height=0.78\textheight,keepaspectratio]{images/rl-real-world/figures/scaling-laws.jpg}%
