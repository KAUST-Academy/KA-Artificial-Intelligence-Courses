...
\begin{frame}{}
    \LARGE Learning from Videos: \textbf{Data Acquisition \& Challenges}
\end{frame}
...
\framebreak
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth,height=0.75\textheight,keepaspectratio]{images/video/dataset.png}
        \caption*{[Source: \url{https://huggingface.co/datasets?task_categories=task_categories:video-classification}]}
    \end{figure}
\end{frame}
...
\framebreak
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth,height=0.82\textheight,keepaspectratio]{images/video/slide_6_1_img.jpg}
        \caption*{\tiny [Source: UMich EECS 498 (2022), Lecture 24: Videos, slide 10]}
    \end{figure}
\framebreak
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth,height=0.82\textheight,keepaspectratio]{images/video/slide_7_1_img.jpg}
        \caption*{\tiny [Source: UMich EECS 498 (2022), Lecture 24: Videos, slide 11]}
    \end{figure}
\framebreak
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textbf{Weak \& Self-Supervision:} Using unlabeled or partially labeled data reduces reliance on expensive manual annotations.
        \end{itemize}
    \end{itemize}
\end{frame}