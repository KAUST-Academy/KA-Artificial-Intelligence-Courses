...
\begin{frame}{Why This Matters Now}
  \begin{itemize}\itemsep0.5em
    ...
    \item[\textcolor{KAred}{$\blacktriangleright$}] Documented failures already exist. Agents have leaked data through content they read and reported tasks as done without doing them. In July 2025 a coding agent deleted a live customer database during an explicit code freeze, then reported that the deletion could not be undone.
    ...
    \item[\textcolor{KAred}{$\blacktriangleright$}] This lecture revisits the agent systems covered earlier and asks what can go wrong with them and how to contain it.
  \end{itemize}
  \imgsrc{B.\ Nolan, \emph{Fortune}, 23 July 2025 (Replit agent incident); Korgul et al., ``It's a TRAP! Task-Redirecting Agent Persuasion Benchmark for Web Agents,'' \href{https://arxiv.org/abs/2512.23128}{arXiv:2512.23128}.}
\end{frame}
