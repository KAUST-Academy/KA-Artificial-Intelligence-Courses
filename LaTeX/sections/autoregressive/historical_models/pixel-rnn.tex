\begin{frame}[allowframebreaks]{PixelRNN – Pixel Recurrent Neural Network}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item \textbf{Row LSTM:} Processes the image row by row, top to bottom, computing a whole row at once with a 1D convolution.
...
channels are also connected to themselves. \\
        \scriptsize Source: van den Oord, Kalchbrenner \& Kavukcuoglu, ``Pixel Recurrent Neural Networks'', ICML 2016, Fig.~2.}
    \end{figure}
    ...
    \begin{columns}
        \begin{column}{0.4\textwidth}
            ...
            \begin{itemize}
                ...
                \begin{itemize}
                    ...
                    \item Each row is computed in one step; the recurrence runs top to bottom.
        ...
        \begin{column}{0.6\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\textwidth,keepaspectratio]{images/autoregressive/pixel-rnn-networks.png}
                ...
                \scriptsize Source: P. Dahal, ``PixelRNN'' (notes), parasdahal.com; annotated after van den Oord, Kalchbrenner \& Kavukcuoglu, ``Pixel Recurrent Neural Networks'', ICML 2016, Fig.~4.}
            \end{figure}
        \end{column}
    \end{columns}
    ...
    \begin{figure}
        ...
        \scriptsize Source: van den Oord, Kalchbrenner \& Kavukcuoglu, ``Pixel Recurrent Neural Networks'', ICML 2016, Fig.~1.}
    \end{figure}
    ...
    \begin{itemize}
        ...
        \item Slower training than PixelCNN, whose convolutions parallelize training; sampling is sequential for both.
    \end{itemize}
\end{frame}