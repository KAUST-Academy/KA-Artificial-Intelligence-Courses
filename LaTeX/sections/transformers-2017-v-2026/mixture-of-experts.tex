...
\begin{frame}[t]{MoE milestones}
  \centering
  \includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{images/transformers-2017-v-2026/moe_survey_fig1_timeline.png}
  \vspace{0.2em}
...
\begin{frame}[t]{MoE for a decoder-only Transformer}
  \centering
  \includegraphics[width=\linewidth,height=0.62\textheight,keepaspectratio]{images/transformers-2017-v-2026/moe_survey_fig5a_moe_layer.png}
...
\begin{frame}[t]{Example: Mixtral 8$\times$7B --- a common misconception}
  ...
  \end{itemize}
  \centering
  \includegraphics[width=0.72\textwidth,height=0.48\textheight,keepaspectratio]{images/transformers-2017-v-2026/nvidia_blog_mixtral_misread_diagram.png}
  \vfill
...
\begin{frame}{MoE: Most Preferred Tokens By Experts}
  \centering
  \includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]{images/transformers-2017-v-2026/most-common-tokens-processed-moe.png}
  \linebreak
  {\scriptsize \textit{Reference:} Kranen \& Nguyen, ``Applying Mixture of Experts in LLM Architectures,'' NVIDIA Technical Blog (2024), \href{https://developer.nvidia.com/blog/applying-mixture-of-experts-in-llm-architectures/}{article}.}
\end{frame}
