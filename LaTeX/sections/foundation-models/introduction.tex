...
\begin{frame}{Adaptation in Practice: From Frozen Probes to LoRA}
  \begin{itemize}\itemsep0.28em
    \item \textbf{Frozen probes:} keep the backbone fixed and train a small head on top (linear or attentive probe, as covered earlier). Cheapest option; also the standard way to \emph{evaluate} a foundation model.
