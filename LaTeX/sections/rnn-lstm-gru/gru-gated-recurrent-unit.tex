...
\begin{frame}{GRU - Gated Recurrent Units}
  \centering
  \includegraphics[width=0.9\paperwidth,height=0.95\paperheight,keepaspectratio]{images/rnn-lstm-gru/gru_long_range_dependency_example.png}
\end{frame}

\begin{frame}{GRU - Gated Recurrent Unit}
  \centering
  \includegraphics[width=0.9\paperwidth,height=0.95\paperheight,keepaspectratio]{images/rnn-lstm-gru/gru_cell_diagram_equations.png}
\end{frame}

\begin{frame}{Vanilla RNN vs GRUs}
  \centering
  \includegraphics[width=0.9\paperwidth,height=0.95\paperheight,keepaspectratio]{images/rnn-lstm-gru/gru_vs_vanilla_rnn_comparison.png}
\end{frame}
