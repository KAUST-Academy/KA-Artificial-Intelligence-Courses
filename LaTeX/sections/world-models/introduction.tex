...
\begin{frame}{World Models: Motivation}
  \textbf{Intuition:} a baseball batter reacts in milliseconds; the swing relies on a \textbf{predictive}, action-conditioned internal model, not on slow deliberate search.
  \centering
...
\begin{frame}{World Models: Motivation (cont.\ I)}
  \centering
  \vspace{0.1em}
...
\begin{frame}{World Models: Motivation (cont.\ II)}
  \centering
  \vspace{0.1em}
...
\begin{frame}{World Models: The Core Idea}
...
\begin{frame}{What Does a World State Hold?}
...
\begin{frame}{World Models: Prediction, Imagination, and Latents}
  \begin{itemize}
...
\begin{frame}{How could we use a World Model (WM)?}
  \begin{enumerate}
    ...
    \item Create interactive worlds (computer games) through prompting
...
%   \centering
%   \vspace{0.1em}
%   \includegraphics[width=\linewidth,height=0.88\textheight,keepaspectratio]{images/world-models/cmu10423_lecture26_world_models_slide08.png}\\[0.32em]
...
%   \centering
%   \vspace{0.1em}
%   \includegraphics[width=\linewidth,height=0.88\textheight,keepaspectratio]{images/world-models/cmu10423_lecture26_world_models_slide09.png}\\[0.32em]
...
\begin{frame}{Paradigms: Generated 3D Worlds (World Labs)}
  \centering
  \vspace{0.1em}
  \includegraphics[width=\linewidth,height=0.88\textheight,keepaspectratio]{images/world-models/world_labs.png}\\[0.32em]
