\begin{frame}[allowframebreaks]{Unsupervised Learning - Challenges}
    ...
    \begin{itemize}
        ...
        \item \textbf{Lack of labeled data}: There is no supervision signal to guide the learning process toward task-relevant structure.
        \item \textbf{Interpretability issues}: The patterns and representations discovered can be hard to interpret or validate.
    \end{itemize}
\end{frame}