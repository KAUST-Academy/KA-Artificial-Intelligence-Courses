...
\begin{frame}[plain]
  \centering
  \includegraphics[width=0.8\paperwidth,height=0.8\paperheight,keepaspectratio]{images/multimodal-nlp-agentic-ai/multimodal_agent_system_overview.png}
\end{frame}
  ...
  \begin{enumerate}
    ...
    \item Vision-Language Models
      \begin{enumerate}
        ...
        \item VisualBERT
        \item FLAVA: Foundational Language And Vision Alignment
      \end{enumerate}
