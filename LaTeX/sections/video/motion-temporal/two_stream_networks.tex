...
\begin{frame}[allowframebreaks]{Two-Stream Network Architecture}
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth,height=0.82\textheight,keepaspectratio]{images/video/slide_23_1_img.jpg}
        \caption*{\tiny [Source: UMich EECS 498 (2022), Lecture 24: Videos, slide 45]}
    \end{figure}
\framebreak
    \begin{itemize}
...
\framebreak
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth,height=0.82\textheight,keepaspectratio]{images/video/slide_24_1_img.png}
        \caption*{\tiny [Source: UMich EECS 498 (2022), Lecture 24: Videos, slide 46]}
    \end{figure}
\end{frame}