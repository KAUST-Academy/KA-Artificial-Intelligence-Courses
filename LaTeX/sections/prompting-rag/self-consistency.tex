...
Many examples were generated but\\the model kept responding 35 as the answer
  ...
  {\scriptsize
    \color{gray!75!black}
    Source: \url{https://arxiv.org/abs/2203.11171} (adapted presentation, Lady Margaret Hall, Oxford)
  }
\end{frame}
...
\textbf{A:} We start with 25 trees and later have 34. The difference must be the number they planted, so they planted 34 - 25 = \textcolor{orange!80!black}{9} trees.\\[0.4em]
\textbf{Q:} If there are 3 cars in the parking lot and 2 more cars arrive, how many cars are now in the parking lot?\\
\textbf{A:} There were 3 cars and 2 arrived, so 3 + 2 = \textcolor{orange!80!black}{5} cars.\\[0.4em]
\textbf{Q:} Olivia has \$23. She bought five bagels for \$3 each. How much money does she have left?\\
\textbf{A:} She bought 5 bagels for \$3 each. This means she spent 5 $\times$ 3 = \$15. So, 23 - 15 = \textcolor{orange!80!black}{8} dollars.\\[0.4em]
...
\texttt{When I was 6 my sister was half my age, so she was 3. Now I am 70, so she is 70 / 2 = 35 years old.}
      };
  ...
  \vspace{-0.3em}
  {\footnotesize
    Two of the three sampled paths answer \textbf{67} and one answers 35, so the majority vote
    returns 67. Marginalising over reasoning paths recovers the correct answer even when
    individual paths are wrong.
  }
\end{frame}
