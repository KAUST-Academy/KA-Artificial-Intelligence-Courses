...
\begin{frame}{Segment Anything Model (SAM): Promptable Segmentation}
  \centering
  \includegraphics[width=\textwidth,height=0.86\textheight,keepaspectratio]{images/foundation-models/sam_promptable_segmentation_overview.png}
\end{frame}

\begin{frame}{SAM: Zero-Shot Segmentation Examples}
  \centering
  \includegraphics[width=\textwidth,height=0.86\textheight,keepaspectratio]{images/foundation-models/sam_zero_shot_segmentation_examples.png}
\end{frame}
...
\begin{frame}{How Does SAM Work?}
  ...
  \end{itemize}
  \centering
  \includegraphics[width=0.85\textwidth]{images/foundation-models/sam_schema.png}
\end{frame}
...
\begin{frame}{SAM 2: Promptable Segmentation in Video}
  \begin{itemize}\itemsep0.3em
    ...
    \item \textbf{Streaming memory:} a memory bank stores features and object pointers from past frames; each new frame \textbf{cross-attends} to this memory before decoding its mask (the attention mechanism from the transformer lectures).
...
\begin{frame}{SAM 1, SAM 2, and SAM 3: What's the Difference?}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.32\textwidth}
      \textbf{SAM 3}
      \begin{itemize}\footnotesize
        \item Detect, segment, and track every instance of any object category in image or video.
...
\begin{frame}{SAM 3 Architecture: Core Model}
  ...
  {\scriptsize SAM 3 model summary and detector/tracker architecture.}\\[0.2em]
  \footnotesize
