\begin{frame}{Scaling}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=.74\textwidth,keepaspectratio]{images/pre-processing/scaling_1.png}
    \end{figure}
\end{frame}
...
\begin{frame}{Min-max scaling}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.59\textwidth,keepaspectratio]{images/pre-processing/scaling_4.png}
    \end{figure}
\end{frame}
...
\begin{frame}{Maximum Absolute scaler}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.73\textwidth,keepaspectratio]{images/pre-processing/scaling_7.png}
    \end{figure}
\end{frame}
