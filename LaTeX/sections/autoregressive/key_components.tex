...
\begin{frame}[allowframebreaks]{Key Components and Architectures}
    ...
    \begin{figure}
    \centering
    \includegraphics[height=0.38\textheight, width=\textwidth, keepaspectratio]{images/autoregressive/autoregressive.png}
...
\begin{itemize}
    ...
    $$\mathcal{P}(x_1, \cdots, x_{784}) = \mathcal{P}(x_1) \mathcal{P}(x_2|x_1) \mathcal{P}(x_3|x_1, x_2) \cdots \mathcal{P}(x_{784}|x_1, x_2, \cdots, x_{783})$$
