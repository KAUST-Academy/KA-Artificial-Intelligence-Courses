...
\begin{tabular}{|c|c|c|l|c|}
    \hline
    \textbf{Run} & \textbf{Commit} & \textbf{Seed} & \textbf{Change from baseline} & \textbf{Val F1} \\
    \hline
...
\begin{itemize}
    ...
    \item Tools such as TensorBoard, MLflow and Weights \& Biases automate this and version the artifacts too --- covered in the MLOps deck of the Introduction to AI course.
\end{itemize}
\end{frame}
