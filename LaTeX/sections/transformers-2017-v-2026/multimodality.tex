...
\begin{frame}[t]{Early Fusion approaches: MLP Adapter}
  ...
  \end{itemize}
  \centering
  \includegraphics[width=\textwidth,height=0.58\textheight,keepaspectratio]{images/transformers-2017-v-2026/bandaru_vlm_llava_architecture.png}
  \vspace{0.15em}
...
\begin{frame}[t]{Early Fusion approaches: Cross-Attention}
  ...
  \end{itemize}
  \centering
  \includegraphics[width=\textwidth,height=0.58\textheight,keepaspectratio]{images/transformers-2017-v-2026/bandaru_vlm_qwen_vl_adapter.png}
  \vfill
...
%   \end{itemize}
%   \centering
%   \includegraphics[width=\textwidth,height=0.55\textheight,keepaspectratio]{images/transformers-2017-v-2026/bandaru_vlm_chameleon_architecture.png}
%   \vspace{0.15em}
...
\begin{frame}[t]{Middle Fusion Approaches: Flamingo}
  ...
  \end{itemize}
  \centering
  \includegraphics[width=\textwidth,height=0.52\textheight,keepaspectratio]{images/transformers-2017-v-2026/bandaru_vlm_flamingo_architecture.png}
  \vfill
...
%   \end{itemize}
%   \centering
%   \includegraphics[width=\textwidth,height=0.52\textheight,keepaspectratio]{images/transformers-2017-v-2026/bandaru_vlm_blip2_training_stages.png}
%   \vspace{0.15em}
...
%   \end{itemize}
%   \centering
%   \includegraphics[width=\textwidth,height=0.48\textheight,keepaspectratio]{images/transformers-2017-v-2026/bandaru_vlm_qwen_vl_training_stages.png}
%   \vspace{0.15em}
...
%   \end{itemize}
%   \centering
%   \includegraphics[width=\textwidth,height=0.48\textheight,keepaspectratio]{images/transformers-2017-v-2026/bandaru_vlm_rlt_video_compression.png}
%   \vspace{0.15em}
...
%   \centering
%   \includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{images/transformers-2017-v-2026/llava_vlm_example.png}
%   \vfill
