...
\begin{frame}{The Geometry of Regularization (LASSO)}
    ...
    \begin{columns}
        ...
        \end{itemize}
        \begin{center}
            \includegraphics[height=3.2cm]{images/linear-regression/linear-regression-24.png}
        \end{center}
        ...
        \end{itemize}
        \begin{center}
            \includegraphics[height=3.2cm]{images/linear-regression/linear-regression-25.png}
        \end{center}
    \end{columns}
\end{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=0.60\textwidth]{images/linear-regression/linear-regression-34.png}
    \caption*{
        \small
