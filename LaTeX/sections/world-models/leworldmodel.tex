...
\begin{frame}[t]{LeWorldModel (LeWM): Motivation}
  \centering
  \includegraphics[width=0.82\linewidth,height=0.62\textheight,keepaspectratio]{images/world-models/leworldmodel_arxiv2603_fig1_training_pipeline_crop.png}\\[-0.08em]
