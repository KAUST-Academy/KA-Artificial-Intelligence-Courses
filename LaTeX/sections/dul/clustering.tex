...
\begin{columns}
    \begin{column}{0.45\textwidth}
        ...
        \begin{itemize}
            ...
            \item Groupings are determined from  attributes of the data itself, which is what  differs from classification.
        \end{itemize}
    \end{column}
    \begin{column}{0.55\textwidth}
        \begin{figure}
            \centering
            \includegraphics[width=0.95\textwidth,keepaspectratio]{images/dul/clustering-example.png}
...
\begin{algorithm}[H]
\caption{Centroid-Based (K-means-style) Clustering}
...
\begin{figure}
    ...
    \caption{Sample data points. [Source: CME 250, S. Wang, Stanford]}
\end{figure}
...
\begin{columns}
    \begin{column}{0.5\textwidth}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=0.92\textwidth,height=0.46\textheight,keepaspectratio]{images/dul/sample-result-classification.png}
    ...
    \begin{column}{0.5\textwidth}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=0.92\textwidth,height=0.46\textheight,keepaspectratio]{images/dul/sample-result-clustering.png}
            \caption{Clustering result.}
        \end{figure}
    \end{column}
\end{columns}
\centering
{\scriptsize [Source: CME 250, S. Wang, Stanford]}
\end{frame}
...
\begin{frame}[allowframebreaks]{Clustering: Types}
    \begin{itemize}
        ...
        \item \textbf{Density-Based Clustering}: Grows clusters out of regions where points are packed closely together and labels sparse regions as noise, such as DBSCAN or OPTICS.
