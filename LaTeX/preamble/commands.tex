...
% Accent red used for emphasis across decks (deepseek_r1, modern-asr, ...)
\definecolor{KAred}{RGB}{200,16,46}
% KAUST accent palette (used by the foundation-models deck)
\definecolor{KAUSTred}{RGB}{200,16,46}
\definecolor{KAUSTblue}{RGB}{0,96,158}
\definecolor{KAUSTcyan}{RGB}{0,157,172}
...
% Note: literal % characters for the shell commands must be written as
% \@percentchar, otherwise they start TeX comments inside the definition
% and eat the closing braces (runaway argument at end of file).
\makeatletter
\newcommand{\includeGIF}[4]{%
  ...
  \IfFileExists{\frameprefix000.png}{}{%
    \immediate\write18{mkdir -p \gifpath}%
    \immediate\write18{convert "\giffile" "\frameprefix\@percentchar03d.png"}%
    \immediate\write18{identify -format \@percentchar n "\giffile" > "\gifpath/\basename\_framecount.txt"}%
  }%
