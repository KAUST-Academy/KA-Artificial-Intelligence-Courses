...
\begin{frame}{Conformer: Convolution-augmented Transformer for Speech Recognition}
  ...
  \vspace{0.6em}
  \centering
  \includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{images/stt/stt_conformer_block_architecture.png}
...
\begin{frame}{Whisper encoder}
  \begin{columns}[c]
    ...
    \begin{column}{0.58\textwidth}
      \centering
      \includegraphics[width=\textwidth,keepaspectratio]{images/stt/stt_whisper_encoder_detail.png}
    \end{column}
  \end{columns}
\end{frame}
