...
\begin{frame}{REINFORCE in Action: Recurrent Attention Model (RAM)}
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth,height=0.6\textheight,keepaspectratio]{images/vanilla-policy-gradient/ram_1.png}
    \end{figure}
    \begin{itemize}
...
\begin{frame}{REINFORCE in Action: Recurrent Attention Model (RAM)}
    \begin{figure}
        \centering
        \includegraphics[width=1.0\textwidth,height=1.0\textheight,keepaspectratio]{images/vanilla-policy-gradient/ram_2.png}
    \end{figure}
    \footnotetext{[Mnih et al., 2014]}
\end{frame}
