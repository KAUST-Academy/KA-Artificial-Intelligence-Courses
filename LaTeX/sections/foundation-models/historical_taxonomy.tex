...
% --- Generative class in brief (cohort skipped the VAE/GAN/diffusion lectures) ---
\begin{frame}{The Generative Class in Brief}
  \begin{itemize}\itemsep0.3em
    ...
    \item \textbf{Vision-language generative models} (Flamingo, GPT-4V, LLaVA): a vision encoder feeds visual tokens into an \textbf{LLM} through a small projector, the same pattern as the V-JEPA 2 language alignment seen last lecture. The LLM then generates text about the image.
    ...
    \item This lecture focuses on the \textbf{representation-learning} class; generative modeling has its own dedicated lectures in the full course.
  \end{itemize}
\end{frame}
