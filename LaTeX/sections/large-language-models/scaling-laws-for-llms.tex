...
\begin{frame}{Why is this interesting? Look at data scaling}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[width=0.65\linewidth, height=0.65\paperheight, keepaspectratio]{assets/Lecture-7_Large_Language_Models/pdf_page_030.png}
  \end{center}
\end{frame}
...
\begin{frame}{Model Scaling: GPT-3}
  \centering
  \includegraphics[width=0.8\paperwidth,height=0.8\paperheight,keepaspectratio]{assets/Lecture-7_Large_Language_Models/pdf_page_034.png}
\end{frame}
