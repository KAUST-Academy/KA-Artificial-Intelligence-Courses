...
\begin{frame}{Four Things That Go Wrong in Practice}
    ...
    \begin{itemize}
        ...
        \item \textbf{You may not have the group labels.} They are often unavailable --- never
              collected, or deliberately not stored. Options: a consented subset for audit only, an
...
\begin{frame}{Trade-offs, Monitoring, and Tooling}
    ...
    \begin{block}{}
        \centering
        \small \textbf{Exercise:} disaggregate on UCI Adult, show the parity/odds tension, apply
        threshold post-processing, and measure what it cost.
    \end{block}
\end{frame}
