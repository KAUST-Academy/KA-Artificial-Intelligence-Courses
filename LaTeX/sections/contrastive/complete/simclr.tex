...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth,height=0.78\textheight,keepaspectratio]{images/contrastive/slide_73_1_img.png}
\end{figure}
{\footnotesize Source: Chen, Kornblith, Norouzi \& Hinton, ``A Simple Framework for Contrastive Learning of Visual Representations,'' ICML 2020, Fig.~2.}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth,height=0.75\textheight,keepaspectratio]{images/contrastive/slide_74_1_img.png}
\end{figure}
{\footnotesize Source: Chen, Kornblith, Norouzi \& Hinton, ``A Simple Framework for Contrastive Learning of Visual Representations,'' ICML 2020, Algorithm~1.}

\framebreak

\begin{figure}
    \centering
    \includegraphics[width=\linewidth,height=0.78\textheight,keepaspectratio]{images/contrastive/slide_75_1_img.png}
\end{figure}
{\footnotesize Source: Chen, Kornblith, Norouzi \& Hinton, ``A Simple Framework for Contrastive Learning of Visual Representations,'' ICML 2020, Fig.~1.}

\framebreak

\begin{figure}
    \centering
    \includegraphics[width=\linewidth,height=0.78\textheight,keepaspectratio]{images/contrastive/slide_76_1_img.png}
\end{figure}
{\footnotesize Source: Chen, Kornblith, Norouzi \& Hinton, ``A Simple Framework for Contrastive Learning of Visual Representations,'' ICML 2020, Fig.~7.}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth,height=0.78\textheight,keepaspectratio]{images/contrastive/slide_77_1_img.png}
\end{figure}
{\footnotesize Source: Chen, Fan, Girshick \& He, ``Improved Baselines with Momentum Contrastive Learning,'' arXiv:2003.04297, 2020, Fig.~1.}
...
\end{figure}
{\footnotesize Source: Chen, Fan, Girshick \& He, ``Improved Baselines with Momentum Contrastive Learning,'' arXiv:2003.04297, 2020, Table~1.}
...
\end{figure}
{\footnotesize Source: Chen, Fan, Girshick \& He, ``Improved Baselines with Momentum Contrastive Learning,'' arXiv:2003.04297, 2020, Table~2.}
