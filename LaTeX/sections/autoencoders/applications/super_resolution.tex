...
\begin{figure}
    \centering
    \includegraphics[height=0.66\textheight, width=\textwidth, keepaspectratio]{./images/autoencoder/image_enhancement.png}
    \caption*{Image super-resolution using Autoencoders\\ {\scriptsize Source: A. J. Champandard, \href{https://github.com/alexjc/neural-enhance}{Neural Enhance}, 2016.}}
\end{figure}
