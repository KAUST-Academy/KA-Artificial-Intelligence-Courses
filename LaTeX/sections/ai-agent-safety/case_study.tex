...
\begin{frame}{Open Problems}
  \begin{itemize}\itemsep0.5em
    \item[\textcolor{KAred}{$\blacktriangleright$}] \textbf{Reliable data and instruction separation:} there is still no robust way to make a model treat retrieved content strictly as data. Injection remains largely unsolved.
