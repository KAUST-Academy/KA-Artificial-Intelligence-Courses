...
\begin{frame}[t]{LeWorldModel (LeWM): Latent Planning}
  ...
  \vspace{-0.7em}
  \centering
  {\scriptsize Image credit: Maes et al., \href{https://arxiv.org/pdf/2603.19312v1.pdf}{LeWorldModel (arXiv:2603.19312)}, Fig.~4.}
\end{frame}
...
\begin{frame}{Synthesis: Four Design Points}
  \begin{itemize}\itemsep0.26em
    ...
    \item \textbf{V-JEPA 2 (+AC):} non-generative video SSL at scale; an action-conditioned head plus CEM planning brings it to robotics (covered earlier).
