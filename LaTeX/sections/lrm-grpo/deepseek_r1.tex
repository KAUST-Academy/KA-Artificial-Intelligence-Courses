\begin{frame}{Example of Reinforcement Learning for Reasoning Skill Refinement: DeepSeek-R1}
  \centering
  \includegraphics[width=\textwidth,height=0.90\textheight,keepaspectratio]{images/lrm-grpo/deepseek_r1_nvidia_market_reaction.png}
\end{frame}

\begin{frame}{Example of Reinforcement Learning for Reasoning Skill Refinement: DeepSeek-R1}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.90\textheight,keepaspectratio]{images/lrm-grpo/deepseek_r1_pipeline_overview_highlighted.png}
    \caption*{DeepSeek-R1 training pipeline overview, adapted from Stanford CS224N (Choi, 2026). Paper: \href{https://arxiv.org/abs/2501.12948}{arXiv:2501.12948}.}
  \end{figure}
\end{frame}
...
\begin{frame}{Example of Reinforcement Learning for Reasoning Skill Refinement: DeepSeek-R1}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.90\textheight,keepaspectratio]{images/lrm-grpo/deepseek_r1_zero_aha_moment_example.png}
  \end{figure}
\end{frame}

\begin{frame}{Reward for R1-zero: keeping it simple}
    \centering
    \includegraphics[width=\textwidth,height=0.90\textheight,keepaspectratio]{images/lrm-grpo/deepseek_r1_zero_reward_design.png}
\end{frame}

\begin{frame}{Emergent reasoning capabilities}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.90\textheight,keepaspectratio]{images/lrm-grpo/deepseek_r1_zero_emergent_capabilities.png}
  \end{figure}
\end{frame}
...
\begin{frame}{Emergent undesirable characteristics of R1-Zero}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.90\textheight,keepaspectratio]{images/lrm-grpo/deepseek_r1_zero_undesirable_characteristics.png}
  \end{figure}
\end{frame}
...
\begin{frame}{Example of Reinforcement Learning for Reasoning Skill Refinement: DeepSeek-R1}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.90\textheight,keepaspectratio]{images/lrm-grpo/deepseek_r1_full_training_pipeline.png}
  \end{figure}
\end{frame}
