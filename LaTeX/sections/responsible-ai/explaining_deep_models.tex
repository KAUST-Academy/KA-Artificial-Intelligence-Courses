...
\begin{frame}{``Attention Is Not Explanation'' --- and the Reply}
    ...
    \begin{block}{What to do in practice}
        \centering
        \scriptsize Use attention maps as a \textbf{debugging view}, never as a justification for a
        user or a regulator. For a transformer attribution, use a method built for it (Integrated
