...
\begin{frame}[allowframebreaks]{Frame Reordering}
    ...
    \begin{figure}
        ...
        \caption*{\tiny [Misra et al., Shuffle and Learn: Unsupervised Learning using Temporal Order Verification, ECCV 2016]}
    \end{figure}
\framebreak
...
\framebreak
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth,height=0.82\textheight,keepaspectratio]{images/video/slide_45_1_img.jpg}
        \caption*{\tiny [Misra et al., Shuffle and Learn: Unsupervised Learning using Temporal Order Verification, ECCV 2016]}
    \end{figure}
\framebreak
    ...
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth,height=0.8\textheight,keepaspectratio]{images/video/slide_46_1_img.jpg}
    \end{figure}
