...
\begin{frame}{Where We Left Off}
    ...
    \begin{block}{Already covered earlier in the course}
        What a hyperparameter is, and structural versus optimisation hyperparameters. Building on that:
        \textbf{grid search} enumerates a discretised product of ranges, \textbf{random search} draws
        configurations independently from them, and both score each candidate on a validation split.
    \end{block}
