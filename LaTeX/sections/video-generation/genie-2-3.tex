\begin{frame}[t]{Genie-2}
  ...
  \includegraphics[width=\linewidth,height=0.86\textheight,keepaspectratio]{images/video-generation/genie2_diffusion_world_model.png}\\[0.28em]
...
\begin{frame}[t]{Genie-2}
  ...
  \end{itemize}
  \vfill
  \includegraphics[width=0.85\linewidth,height=0.85\textheight,keepaspectratio]{images/video-generation/genie2_gameplay_examples.png}\\[0.28em]
  {\scriptsize Source: CMU Lecture 26, World Models.}
\end{frame}

\begin{frame}[t]{Genie-3}
\centering
\includegraphics[width=0.85\linewidth,height=0.95\textheight,keepaspectratio]{images/video-generation/genie3_comparison_table.png}\\[0.28em]
{\scriptsize Source: CMU Lecture 26, World Models.}
\end{frame}

\begin{frame}[t]{Genie-3}
  \centering
  \includegraphics[width=0.85\linewidth,height=0.85\textheight,keepaspectratio]{images/video-generation/genie3_wingsuit_demo.png}\\[0.28em]
  {\scriptsize Source: CMU Lecture 26, World Models.}
\end{frame}
