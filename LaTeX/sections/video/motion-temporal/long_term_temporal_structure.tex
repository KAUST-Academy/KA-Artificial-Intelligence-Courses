...
\begin{frame}{Modelling Long-Term Structure}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.88\textwidth,height=0.5\textheight,keepaspectratio]{images/video/slide_25_1_img.png}
        \caption*{\tiny [Source: UMich EECS 498 (2022), Lecture 24: Videos, slide 47]}
    \end{figure}
\end{frame}

\begin{frame}{Modelling Long-Term Structure with RNNs}
    \begin{itemize}
    ...
    \begin{figure}
        ...
        \caption*{\tiny [Source: UMich EECS 498 (2022), Lecture 24: Videos, slide 52]}
    \end{figure}
\end{frame}
...
\framebreak
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth,height=0.82\textheight,keepaspectratio]{images/video/slide_29_1_img.png}
        \caption*{\tiny [Source: UMich EECS 498 (2022), Lecture 24: Videos, slide 58]}
    \end{figure}
\framebreak
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth,height=0.82\textheight,keepaspectratio]{images/video/slide_30_1_img.jpg}
        \caption*{\tiny [Source: UMich EECS 498 (2022), Lecture 24: Videos, slide 60]}
    \end{figure}
\end{frame}

\begin{frame}[allowframebreaks]{Modelling Long-Term Structure: RNNs vs. CNNs}
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth,height=0.82\textheight,keepaspectratio]{images/video/slide_31_1_img.jpg}
        \caption*{\tiny [Source: UMich EECS 498 (2022), Lecture 24: Videos, slide 62]}
    \end{figure}
\framebreak
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth,height=0.82\textheight,keepaspectratio]{images/video/slide_32_1_img.jpg}
        \caption*{\tiny [Source: UMich EECS 498 (2022), Lecture 24: Videos, slide 63]}
    \end{figure}
\end{frame}

\begin{frame}{Approaches to Long-Term Temporal Modelling}
