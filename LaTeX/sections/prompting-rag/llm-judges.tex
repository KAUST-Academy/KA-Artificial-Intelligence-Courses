...
\begin{frame}{When Benchmarks Saturate: Frontier Exams}
  \begin{itemize}\itemsep0.45em
    ...
    \item[\textcolor{red}{$\blacktriangleright$}] \textbf{Humanity's Last Exam} (2025) goes further: 2{,}500 questions written by over 1{,}000 subject experts, designed as ``the final closed-ended academic benchmark of its kind.'' Frontier models scored below 10\% at release.
