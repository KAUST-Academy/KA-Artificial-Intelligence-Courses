\begin{frame}[allowframebreaks]{Unsupervised Learning - Applications}
    Deep Unsupervised Learning is already used across several areas:
    \begin{itemize}
        ...
        \item \textbf{Flexible Building Blocks}: Provide reusable components for larger machine learning pipelines.
    \end{itemize}
\end{frame}
...
\begin{frame}{Application: DNA Analysis}
    ...
    \caption{Dimensionality reduction applied to DNA reveals the geography of European countries. [Novembre et al., ``Genes mirror geography within Europe'', Nature 456, 2008]}
    \end{figure}
\end{frame}
...
\begin{frame}{Application: Text to Image Generation}
    ...
    \begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth,height=0.68\textheight,keepaspectratio]{images/dul/slide_29_1_img.png}
    \end{figure}
    \centering
    [DALL$\cdot$E 2, OpenAI, 2022]
\end{frame}
