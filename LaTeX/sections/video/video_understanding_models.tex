...
\begin{frame}{}
    \LARGE Learning from Videos: \textbf{Video Understanding Models}
\end{frame}
...
\framebreak
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth,height=0.82\textheight,keepaspectratio]{images/video/slide_4_1_img.jpg}
        \caption*{\tiny [Source: UMich EECS 498 (2022), Lecture 24: Videos, slide 8]}
    \end{figure}
\framebreak
    \begin{itemize}
...
\framebreak
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth,height=0.82\textheight,keepaspectratio]{images/video/slide_5_1_img.jpg}
        \caption*{\tiny [Source: UMich EECS 498 (2022), Lecture 24: Videos, slide 9]}
    \end{figure}
\framebreak
    \begin{itemize}
...
\input{sections/video/video-understanding/training_clips}
\input{sections/video/video-understanding/single_frame_cnn}
\input{sections/video/video-understanding/late_fusion}
\input{sections/video/video-understanding/early_fusion}
\input{sections/video/video-understanding/3d_cnn}
\input{sections/video/video-understanding/c3d}