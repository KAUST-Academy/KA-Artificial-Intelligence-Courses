\begin{frame}[allowframebreaks]{}
    \begin{figure}
        \centering
        \fetchconvertimage{https://framerusercontent.com/images/BTYwexvG8pobxihJcbBy0Vp4aE.png}{images/contrastive/architecture.png}{height=0.8\textheight,width=1\textwidth,keepaspectratio}
        {\footnotesize [Source: \url{https://framerusercontent.com/images/BTYwexvG8pobxihJcbBy0Vp4aE.png}]}
    \end{figure}
\end{frame}
