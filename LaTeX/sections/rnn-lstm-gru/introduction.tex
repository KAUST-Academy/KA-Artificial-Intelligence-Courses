...
\begin{frame}{Traditional Language Models}
  \centering
  \includegraphics[width=0.9\paperwidth,height=0.95\paperheight,keepaspectratio]{images/rnn-lstm-gru/rnn_translation_sequence_probability.png}
\end{frame}
...
\begin{frame}[Why Use RNNs]
  \centering
  \includegraphics[width=0.9\paperwidth,height=0.95\paperheight,keepaspectratio]{images/rnn-lstm-gru/rnn_next_word_prediction_candidates.png}
\end{frame}

% Slide 13: RNNs Basic Structure
\begin{frame}{RNNs Basic Structure}
  \centering
  \includegraphics[width=0.9\paperwidth,height=0.95\paperheight,keepaspectratio]{images/rnn-lstm-gru/rnn_language_model_next_word.png}
\end{frame}
