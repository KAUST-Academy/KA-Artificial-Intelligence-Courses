...
\textbf{\large Vanishing Gradients }
    \begin{itemize}
        \item When the discriminator is perfect, we are guaranteed with $D(x) = 1$ for all real samples $x$ and $D(x) = 0$ for all generated samples.
...
\textbf{\large Mode collapse}
    ...
    \begin{figure}
        ...
        \caption*{\scriptsize [Source: \url{https://www.cnblogs.com/recoverableTi/p/13452479.html}]}
    \end{figure}

\framebreak
\begin{figure}
    \centering
    \includegraphics[height=0.7\textheight, width=\textwidth, keepaspectratio]{images/gan/gan_mode_collapse_2.png}
    \caption*{GAN mode collapse on MNIST digits dataset. {\scriptsize [Metz et al., ``Unrolled Generative Adversarial Networks,'' ICLR 2017, Fig.~3]}}
\end{figure}
