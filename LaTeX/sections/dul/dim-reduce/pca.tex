...
\begin{frame}[allowframebreaks]{Assigning Loadings to Genes}
    ...
    \begin{column}{0.5\textwidth}
        \begin{figure}
            \centering
            \includegraphics[width=0.62\textwidth,height=0.44\textheight,keepaspectratio]{images/dul/dim-reduce/line-fit-best.png}
        \end{figure}
    \end{column}
    \begin{column}{0.5\textwidth}
        \begin{figure}
            \centering
            \includegraphics[width=0.62\textwidth,height=0.44\textheight,keepaspectratio]{images/dul/dim-reduce/line-eigenvector.png}
            \caption{\textbf{Eigenvector} or Singular Vector
            [Source: S. Andrews, ``Dimension Reduction'', Babraham Bioinformatics]}
        \end{figure}
    \end{column}
    \end{columns}
    \begin{itemize}
...
\begin{frame}[allowframebreaks]{More Dimensions}    
    ...
    \begin{column}{0.6\textwidth}
        \begin{itemize}
            ...
            \item The number of principal components is at most $\min(\text{number of samples} - 1,\ \text{number of features})$.
        \end{itemize}
    \end{column}
    \end{columns}
    \centering
...
\begin{frame}[allowframebreaks]{Explaining Variance}    
    ...
    \begin{column}{0.5\textwidth}
        \begin{itemize}
            ...
            \item Compute the sum of squared distances (SSD) from the origin.
