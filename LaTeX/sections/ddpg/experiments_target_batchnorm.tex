...
\begin{figure}
    \centering
    \includegraphics[width=0.95\textwidth,height=0.55\textheight,keepaspectratio]{images/ddpg/figures/experiments-target-batchnorm.jpg}
\end{figure}
\begin{itemize}
    \footnotesize
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\textwidth,height=0.5\textheight,keepaspectratio]{images/ddpg/figures/experiments-target-batchnorm.jpg}
\end{figure}
\begin{itemize}
    \footnotesize
    \item[] \textcolor{gray}{Light Grey:} Original DPG
