...
\begin{frame}{V-JEPA: Learning in Representation Space}
  \begin{columns}[T,onlytextwidth]
    ...
    \centering
    \includegraphics[width=0.9\linewidth, height=0.9\textheight, keepaspectratio]{images/jepa/vjepa_encoder_training.png}\\[0.25em]
...
%     \column{0.6\textwidth}
%     \centering
%     \includegraphics[width=0.8\linewidth, height=0.8\textheight, keepaspectratio]{images/jepa/vjepa_blog_eval_chart.png}\\[0.25em]
