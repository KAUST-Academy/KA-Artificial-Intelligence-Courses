...
\begin{frame}{CLIP: Contrastive Language-Image Pretraining \hfill \includegraphics[height=1em]{images/kaust_logo.png}}
  \textbf{Architecture:}
  \begin{itemize}
...
\begin{frame}{CLIP (Radford et al. 2021)}
  ...
  \begin{center}
    \includegraphics[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{images/multimodal-nlp-agentic-ai/multimodal_clip_contrastive_pretraining.png}  
  \end{center}
\end{frame}
...
\begin{frame}{CLIP Robustness}
  ...
  \vspace{1em}
  \begin{center}
    \includegraphics[width=0.65\textwidth, height=0.65\textheight, keepaspectratio]{images/multimodal-nlp-agentic-ai/multimodal_clip_zeroshot_benchmarks.png}
  \end{center}
...
\begin{frame}{VisualBERTs: VisualBERT Architecture}
  \begin{center}
    \includegraphics[width=0.98\textwidth, height=0.98\textheight, keepaspectratio]{images/multimodal-nlp-agentic-ai/multimodal_visualbert_architecture.png}
  \end{center}  
\end{frame}

\begin{frame}{Visual BERTs: ViLBERT}
  \begin{center}
    \includegraphics[width=0.98\textwidth, height=0.98\textheight, keepaspectratio]{images/multimodal-nlp-agentic-ai/multimodal_vilbert_architecture.png}
  \end{center}  
\end{frame}
...
\begin{frame}{Visual BERTs: LXMERT}
  ...
  \begin{center}
    \includegraphics[width=0.92\textwidth, height=0.92\textheight, keepaspectratio]{images/multimodal-nlp-agentic-ai/multimodal_lxmert_architecture.png}
...
\includegraphics[width=0.98\textwidth, height=0.98\textheight, keepaspectratio]{images/multimodal-nlp-agentic-ai/multimodal_pixelbert_architecture.png}
\end{frame}
...
\begin{frame}{FLAVA (Singh et al., 2021)}
  \begin{columns}
    ...
    \begin{column}{0.40\textwidth}
      ...
      \includegraphics[width=\textwidth]{images/multimodal-nlp-agentic-ai/multimodal_one_ring_lotr.png}
    \end{column}
  \end{columns}
\end{frame}
