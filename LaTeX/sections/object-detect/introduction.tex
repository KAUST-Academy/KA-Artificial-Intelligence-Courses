...
\framebreak
    ...
    \begin{figure}
        \centering
        \includegraphics[width=1.0\textwidth,height=0.82\textheight,keepaspectratio]{images/object-detect/object_1.png}
        \caption*{\tiny Source: UMich EECS 498 (2022), Lecture 13: Object Detection, slide 32}
    \end{figure}
