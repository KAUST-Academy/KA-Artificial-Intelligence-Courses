...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=0.58\textheight,keepaspectratio]{images/audio-nlp/mfcc.png}
    \caption*{A block diagram for MFCC computation: From audio signal to MFCC features.\\
    {\scriptsize Source: B.~Barai, D.~Das, N.~Das, S.~Basu and M.~Nasipuri, ``VQ/GMM-Based Speaker Identification with Emphasis on Language Dependency,'' \emph{Advances in Intelligent Systems and Computing} 810, Springer, 2019, Fig.~2.}}
\end{figure}
\framebreak
\textbf{Pipeline:}
\begin{enumerate}
