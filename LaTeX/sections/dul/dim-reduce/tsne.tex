\begin{frame}[allowframebreaks]{tSNE to the rescue\dots}
    ...
    \vspace{1em}
    \centering
    [t-SNE, van der Maaten \& Hinton, JMLR 9, 2008; builds on SNE, Hinton \& Roweis, NIPS 2002]
\end{frame}
...
\begin{frame}[allowframebreaks]{tSNE: How does it work?}
    ...
    \begin{columns}
        \begin{column}{0.33\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=0.85\textwidth,height=0.42\textheight,keepaspectratio]{images/dul/dim-reduce/tsne-points.png}
            \end{figure}
        \end{column}
        \begin{column}{0.33\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=0.85\textwidth,height=0.42\textheight,keepaspectratio]{images/dul/dim-reduce/tsne-graph.png}
            \end{figure}
        \end{column}
        \begin{column}{0.33\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=0.85\textwidth,height=0.42\textheight,keepaspectratio]{images/dul/dim-reduce/tsne-matrix.png}
            \end{figure}
        \end{column}
    \end{columns}
    \centering
    {\scriptsize [Source: S. Andrews, ``Dimension Reduction'', Babraham Bioinformatics]}
\end{frame}
...
\begin{frame}[allowframebreaks]{tSNE: Underlying idea}
    \begin{figure}
        ...
        \caption*{\scriptsize [Source: Z. Fataliyev, ``Dimensionality reduction with t-SNE'', Seoul AI]}
    \end{figure}
\end{frame}
...
\begin{frame}[allowframebreaks]{KL Divergence}
    ...
    \begin{column}{0.4\textwidth}
        Measures how one probability distribution diverges from another; it is asymmetric.
    ...
    \end{columns}
    \centering
    {\scriptsize [Source: Z. Fataliyev, ``Dimensionality reduction with t-SNE'', Seoul AI]}
\end{frame}
...
\begin{frame}[allowframebreaks]{tSNE: Stochastic Neighbor Embedding}
    ...
    \begin{column}{0.6\textwidth}
        \begin{figure}
            \centering
            \includegraphics[width=1\textwidth,height=0.7\textheight,keepaspectratio]{images/dul/dim-reduce/tsne-result-1.png}
            \caption{[Hinton \& Roweis, ``Stochastic Neighbor Embedding'', NIPS 2002, Fig.~1]}
        \end{figure}
    \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}[allowframebreaks]{Symmetric SNE}
    \begin{figure}
        \centering
        \includegraphics[width=0.92\textwidth,height=0.62\textheight,keepaspectratio]{images/dul/dim-reduce/symmetric-sne.jpg}
        \caption*{\scriptsize [Source: Z. Fataliyev, ``Dimensionality reduction with t-SNE'', Seoul AI]}
    \end{figure}
\end{frame}
...
\begin{frame}[allowframebreaks]{t-Distributed Stochastic Neighbor Embedding}
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth,height=0.78\textheight,keepaspectratio]{images/dul/dim-reduce/t-distributed-stochastic.jpg}
        \caption*{\scriptsize [Source: Z. Fataliyev, ``Dimensionality reduction with t-SNE'', Seoul AI]}
    \end{figure}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth,height=0.78\textheight,keepaspectratio]{images/dul/dim-reduce/t-distributed-stochastic-cost.jpg}
        \caption*{\scriptsize [Source: Z. Fataliyev, ``Dimensionality reduction with t-SNE'', Seoul AI]}
    \end{figure}
\end{frame}
...
\begin{frame}[allowframebreaks]{Distance scaling and perplexity}
    \begin{itemize}
        \item Perplexity = effective number of nearest neighbours each point is compared against
...
\begin{frame}[allowframebreaks]{tSNE: Practical Examples}
    \begin{figure}
        \centering
        \includegraphics[width=0.92\textwidth,height=0.58\textheight,keepaspectratio]{images/dul/dim-reduce/tsne-perplexity-settings.png}
        \caption*{\scriptsize [Wattenberg, Vi\'egas \& Johnson, ``How to Use t-SNE Effectively'', Distill 2016,
        via S. Andrews, ``Dimension Reduction'', Babraham Bioinformatics]}
    \end{figure}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.92\textwidth,height=0.58\textheight,keepaspectratio]{images/dul/dim-reduce/tsne-perplexity-settings-2.png}
        \caption*{\scriptsize [Wattenberg, Vi\'egas \& Johnson, ``How to Use t-SNE Effectively'', Distill 2016,
        via S. Andrews, ``Dimension Reduction'', Babraham Bioinformatics]}
    \end{figure}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.92\textwidth,height=0.58\textheight,keepaspectratio]{images/dul/dim-reduce/tsne-perplexity-settings-3.png}
        \caption*{\scriptsize [Wattenberg, Vi\'egas \& Johnson, ``How to Use t-SNE Effectively'', Distill 2016,
        via S. Andrews, ``Dimension Reduction'', Babraham Bioinformatics]}
    \end{figure}
\end{frame}
...
Distance between clusters = high
    ...
    \begin{column}{0.33\textwidth}
        \begin{figure}
            \centering
            \includegraphics[width=1\textwidth,height=0.42\textheight,keepaspectratio]{images/dul/dim-reduce/slide_36_2_img.png}
        \end{figure}
