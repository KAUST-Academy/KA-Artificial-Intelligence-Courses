...
%   \centering
%   \includegraphics[width=\textwidth,height=0.92\textheight,keepaspectratio]{images/stt/stt_conformer_block_architecture.png}
% \end{frame}
...
\begin{frame}{Conformer: Convolution-augmented Transformer for Speech Recognition}
  ...
  \vspace{0.6em}
  \centering
  \includegraphics[width=\textwidth,height=0.5\textheight,keepaspectratio]{images/stt/stt_conformer_block_architecture.png}
...
\begin{frame}{SpecAugment: Augmenting data to increase dataset size}
  ...
  \end{itemize}
  \centering
  \includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{images/stt/stt_specaugment_spectrograms.png}
\end{frame}

% --- Stanford CS224S lec11, slide 6 ---
\begin{frame}{Convolution subsampling: Log mel spectrogram is an image}
  \centering
  \includegraphics[width=\textwidth,height=0.92\textheight,keepaspectratio]{images/stt/stt_conformer_conv_subsampling.png}
\end{frame}
...
%   A conformer is a transformer encoder with a convolutional module in the transformer layer
%   \centering
%   \includegraphics[width=\textwidth,height=0.92\textheight,keepaspectratio]{images/stt/stt_conformer_macaron_layers.png}
% \end{frame}

% --- Stanford CS224S lec11, slide 11 ---
% \begin{frame}{Conformer architecture overview}
%   \centering
%   \includegraphics[width=\textwidth,height=0.92\textheight,keepaspectratio]{images/stt/stt_conformer_title_overview.png}
% \end{frame}

% --- Stanford CS224S lec11, slide 13 ---
\begin{frame}{The convolution block has the\newline greatest effect on performance}
  \begin{columns}[c]
    ...
    \begin{column}{0.47\textwidth}
      \centering
      \\[0.3em]
      \includegraphics[width=\textwidth,height=0.92\textheight,keepaspectratio]{images/stt/stt_conformer_ablation_table.png}
...
\begin{frame}{State-of-the-art ASR: Whisper}
  \centering
  \includegraphics[width=\textwidth,height=0.92\textheight,keepaspectratio]{images/stt/stt_whisper_multilingual_example.png}
\end{frame}

% --- Stanford CS224S lec11, slide 20 ---
\begin{frame}{Whisper: How does it perform a variety of tasks accurately?}
  \centering
  \includegraphics[width=\textwidth,height=0.92\textheight,keepaspectratio]{images/stt/stt_whisper_multitask_seq2seq.png}
\end{frame}

% --- Stanford CS224S lec11, slide 21 ---
\begin{frame}{Whisper: encoder--decoder architecture}
  \centering
  \includegraphics[width=\textwidth,height=0.92\textheight,keepaspectratio]{images/stt/stt_whisper_vs_text_transformer.png}
\end{frame}
...
\begin{frame}{Whisper encoder}
  \begin{columns}[c]
    ...
    \begin{column}{0.58\textwidth}
      \centering
      \includegraphics[width=0.5\textwidth,height=0.6\textheight,keepaspectratio]{images/stt/stt_whisper_encoder_detail.png}    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Whisper decoder: autoregressive transformer decoder}
  \begin{columns}[c]
    ...
    \begin{column}{0.51\textwidth}
      \centering
      \includegraphics[width=\textwidth,height=0.92\textheight,keepaspectratio]{images/stt/stt_whisper_decoder_detail.png}
    \end{column}
  \end{columns}
\end{frame}
