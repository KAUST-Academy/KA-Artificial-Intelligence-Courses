...
\begin{frame}[allowframebreaks]{When to fine-tune your model?}
    \begin{itemize}
        ...
        \begin{itemize}
            \item Fine-tune the entire network (both feature extractor and classifier).
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{Finetuning}
    \begin{figure}
    \centering
    \includegraphics[width=1.0\textwidth,height=0.78\textheight,keepaspectratio]{images/Finetuning_fig.png}
    \caption{Fine-tuning a pretrained ImageNet model for a new task}
    \end{figure}
\footnotetext{Figure: Rahman, Tabassum, Haque, Nishat, Faisal \& Hossain, \href{https://doi.org/10.1109/STI53101.2021.9732592}{``CNN-based Deep Learning Approach for Micro-crack Detection of Solar Panels''}, STI 2021, Fig.~3.}
\end{frame} 