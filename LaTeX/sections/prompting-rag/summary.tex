...
\begin{frame}{Directional Stimulus Prompting}
  ...
  \vspace{1em}
  \begin{center}
    \includegraphics[width=0.8\textwidth,keepaspectratio]{images/prompting-rag/prompting_directional_stimulus_training.png}
  \end{center}
\end{frame}

\begin{frame}[fragile]{Directional Stimulus Prompting Example}
  \begin{center}
    \includegraphics[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{images/prompting-rag/prompting_directional_stimulus_comparison.png}
  \end{center}
\end{frame}
...
\begin{frame}{Prompt Leaking}
  ...
  \vspace{1em}
  \begin{center}
    \includegraphics[width=0.82\textwidth,height=0.65\textheight,keepaspectratio]{images/prompting-rag/prompting_chatgpt_system_prompt_extraction.png}
  \end{center}
  \vspace{0.2em}
...
\begin{frame}{Jailbreaking Example}
  \begin{center}
    \includegraphics[width=0.90\textwidth, height=0.90\textheight, keepaspectratio]{images/prompting-rag/prompting_jailbreak_hotwire_poem.png}
  \end{center}
\end{frame}
...
\begin{frame}{Open problems – a quick (and incomplete) overview}
  \begin{center}
    \includegraphics[width=0.98\textwidth]{images/prompting-rag/prompting_nlp_tasks_overview.png}
  \end{center}
\end{frame}

\begin{frame}{Do our models understand our tasks?}
  \begin{center}
    \includegraphics[width=0.90\textwidth]{images/prompting-rag/prompting_adversarial_examples_entailment.png}
  \end{center}
  \vspace{0.5em}
  \begin{itemize}
...
\begin{frame}{Is there much beyond optimizing IID error? (Generalization)}
  \begin{center}
    \includegraphics[width=0.5\textwidth]{images/prompting-rag/prompting_in_context_learning_squad_shift.png}
  \end{center}
  \vspace{1em}
  \begin{itemize}
...
\begin{frame}{Can we build interpretable, but performant models? (Analysis)}
  \begin{center}
    ...
    \includegraphics[width=0.92\textwidth, height=0.92\textheight, keepaspectratio]{images/prompting-rag/prompting_all_models_wrong_paper_title.png}
  \end{center}
...
\begin{frame}{Can we build interpretable, performant models?}
  \begin{center}
    \includegraphics[width=0.95\textwidth, height=0.95\textheight, keepaspectratio]{images/prompting-rag/prompting_backpack_language_models.png}
  \end{center}
\end{frame}
...
\begin{frame}{Multilingual}
  \begin{center}
    \includegraphics[width=0.95\textwidth, height=0.95\textheight, keepaspectratio]{images/prompting-rag/prompting_gpt4_multilingual_mmlu_gaps.png}
  \end{center}
\end{frame}
...
\includegraphics[width=0.82\textwidth,height=0.92\textheight,keepaspectratio]{images/prompting-rag/prompting_aya_multilingual_dataset.png}  
  \vspace{1em}
  \begin{itemize}
...
\includegraphics[width=0.82\textwidth,height=0.92\textheight,keepaspectratio]{images/prompting-rag/prompting_nlp_benchmark_datasets.png}  
\vspace{1em}
...
\begin{frame}{Evaluating chatbots and open-domain systems (Evaluation)}
    \vspace{0.5em}
    \includegraphics[width=0.82\textwidth,height=0.82\textheight,keepaspectratio]{images/prompting-rag/prompting_chatgpt_vs_alternative_output_length.png}  
    \vspace{0.5em}
    \footnotesize
...
\includegraphics[width=0.95\textwidth,height=0.95\textheight,keepaspectratio]{images/prompting-rag/prompting_attention_not_explanation_papers.png}
\vspace{0.5em}
\footnotesize
\vspace{1em}
...
\begin{frame}{Making NLP work in high-impact domains}
  ...
  \begin{center}
    \includegraphics[width=0.95\textwidth,height=0.95\textheight,keepaspectratio]{images/prompting-rag/prompting_llm_applications_domains.png}  
  \end{center}
  \vspace{1em}
\end{frame}
...
\begin{frame}[allowframebreaks]{Bio / Clinical NLP (Domains)}
  \begin{center}
    \includegraphics[width=0.5\textwidth,height=0.62\textheight,keepaspectratio]{images/prompting-rag/prompting_gpt4_medicine_special_report.png}
    \vspace{1em}
  \end{center}
...
\begin{frame}{Scientific NLP (Domains)}
    \begin{center}
    \includegraphics[width=0.82\textwidth,height=0.72\textheight,keepaspectratio]{images/prompting-rag/prompting_llm_math_discovery_galactica.png}
    \end{center}
    \begin{itemize}
...
\begin{frame}{Education and NLP (Domains)}
    ...
    \begin{center}
    \includegraphics[width=0.88\textwidth]{images/prompting-rag/prompting_bloom_taxonomy_chatgpt_exams.png}
    \end{center}
    \begin{itemize}
...
\begin{frame}{NLP + Other modalities}
    ...
    \begin{center}
    \includegraphics[width=0.82\textwidth, height=0.72\textheight,keepaspectratio]{images/prompting-rag/prompting_gpt4_multimodal_cookie_earth.png}
    \end{center}
    \begin{itemize}
...
\begin{frame}{Image-text (Multimodal)}
    ...
    \begin{center}
    \includegraphics[width=0.82\textwidth, height=0.72\textheight,keepaspectratio]{images/prompting-rag/prompting_llava_flamingo_multimodal.png}
    \end{center}
    \begin{itemize}
...
\begin{frame}{Fairness and social impact}
    \begin{center}
    \includegraphics[width=0.82\textwidth, height=0.72\textheight,keepaspectratio]{images/prompting-rag/prompting_fairness_bias_representations.png}
    \end{center}
\end{frame}

\begin{frame}{Biases and Stereotypes: how to quantify}
  \begin{center}
    \includegraphics[width=0.95\textwidth, height=0.95\textheight,keepaspectratio]{images/prompting-rag/prompting_bias_benchmarks_bbq_stereoset.png}
    \end{center}
\end{frame}
...
\begin{frame}{Fairness and Equity: how to evaluate and mitigate?}
    ...
    \vspace{0.5em}
    \begin{center}
        \includegraphics[width=0.99\textwidth]{images/prompting-rag/prompting_gender_bias_word_analogies.png}
    \end{center}
    \footnotesize
    \textit{Caliskan, A., Bryson, J. J., \& Narayanan, A. (2017). "Semantics derived automatically from language corpora contain human-like biases". Science.}
\end{frame}
...
\begin{frame}{Fairness and Equity: What are unintended impacts of LLMs?}
    ...
    \vspace{0.7em}
    \begin{center}
        \includegraphics[width=0.85\textwidth]{images/prompting-rag/prompting_reward_model_geographic_bias.png}
    \end{center}
    \tiny
...
\includegraphics[width=0.95\textwidth, height=0.95\textheight,keepaspectratio]{images/prompting-rag/prompting_theory_of_mind_commonsense.png}
\end{frame}
        ...
        \begin{column}{0.42\textwidth}
            ...
            \fbox{
                \begin{minipage}[c][0.48\textheight][c]{0.98\columnwidth}
                    \centering
                    \includegraphics[width=0.98\columnwidth]{images/prompting-rag/prompting_ai_energy_consumption.png}
                \end{minipage}
            }
        \end{column}
    \end{columns}
