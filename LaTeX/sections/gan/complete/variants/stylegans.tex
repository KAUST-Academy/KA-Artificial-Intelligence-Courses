...
\footnotetext{\url{https://www.cs.unc.edu/~ronisen/teaching/fall_2022/pdf_lectures/lecture6_gan2.pdf}}
\end{frame}
\begin{frame}[allowframebreaks]{Style GANs}
\begin{figure}
    \centering
...
\begin{itemize}
    ...
    \item \textbf{Ada}ptive \textbf{I}nstance \textbf{N}ormalization (very effective in controlling styles)
...
\begin{itemize}
    ...
    \item \textbf{W+} : 18x512 dimensional latent space (a different 512-d $w$ vector for each of the 18 generator layer inputs)
