\begin{frame}[allowframebreaks]{\textcolor{green}{$\Rightarrow$} Learning Outcomes}
    ...
    \begin{enumerate}
        \item \textbf{Define} deep unsupervised learning and \textbf{differentiate} it from supervised approaches.
        ...
        \end{itemize}
        \item \textbf{Compare} the main clustering algorithms and the assumptions each one makes:
        \begin{itemize}
            \item K-means
