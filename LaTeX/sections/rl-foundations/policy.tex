...
\begin{itemize}
    ...
    \item In large or continuous state spaces this is infeasible --- same curse of dimensionality problem
...
\begin{itemize}
    \item We want to find optimal policy $\pi^{\star}$ that maximizes the sum of reward
