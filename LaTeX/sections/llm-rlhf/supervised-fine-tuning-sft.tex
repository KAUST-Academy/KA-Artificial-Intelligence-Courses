...
\begin{frame}{What is Supervised Fine-Tuning (SFT)?}
  \centering
  \includegraphics[width=0.8\paperwidth,height=0.8\paperheight,keepaspectratio]{assets/Lecture-8_Fine_Tuning_RLHF/slide_015.png}
\end{frame}

\begin{frame}{Supervised Fine-Tuning For Gemini LLM}
  \centering
  \includegraphics[width=0.8\paperwidth,height=0.8\paperheight,keepaspectratio]{assets/Lecture-8_Fine_Tuning_RLHF/slide_016.png}
\end{frame}
