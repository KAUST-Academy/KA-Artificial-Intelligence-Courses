...
Denoising diffusion models, closely related to score-based generative models, have recently emerged as a powerful class of generative models. They achieve remarkable results in high-fidelity image generation, often outperforming GANs.
\begin{figure}
    \centering
...
\begin{figure}
    ...
    \caption*{\scriptsize Ho, Jain \& Abbeel, \href{https://arxiv.org/abs/2006.11239}{Denoising Diffusion Probabilistic Models}, NeurIPS 2020, Fig.~2}
\end{figure}
