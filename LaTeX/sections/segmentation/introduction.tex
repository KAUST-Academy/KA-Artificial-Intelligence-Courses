...
\begin{frame}{What is Image Segmentation?}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=1.0\textwidth,height=0.6\textheight,keepaspectratio]{images/segmentation/segment-intro.png}
        \caption*{\tiny Source: SuperAnnotate, ``Image segmentation detailed overview'', superannotate.com.}
    \end{figure}
\end{frame}
...
\begin{frame}{Computer Vision Tasks}
    \begin{figure}
        ...
        \caption*{\tiny Source: Stanford CS231n (2022), Lecture 9: Object Detection and Image Segmentation, slide 3}
    \end{figure}
    \begin{itemize}
