...
\begin{frame}{What is LoRA?}  
  \centering
  \includegraphics[width=0.60\paperwidth,height=0.60\paperheight,keepaspectratio]{images/llm-rlhf/finetune_lora_weight_update.png}
\end{frame}
...
\begin{frame}{QLoRA --- Quantized LoRA}
  \centering
  \includegraphics[width=0.60\paperwidth,height=0.60\paperheight,keepaspectratio]{images/llm-rlhf/finetune_lora_qlora_memory.png}
\end{frame}

\begin{frame}{QLoRA --- Quantized LoRA}
  \centering
  \includegraphics[width=0.60\paperwidth,height=0.60\paperheight,keepaspectratio]{images/llm-rlhf/finetune_qlora_qalora_layers.png}
\end{frame}
