\begin{frame}{Safety, Ethics, and Control}
  \begin{center}
    \Huge Safety, Ethics, and Control
  \end{center}
\end{frame}
...
\begin{frame}{Safety in Agentic Systems}
  \centering
  \includegraphics[width=0.8\textwidth,height=0.8\textheight,keepaspectratio]{images/multimodal-nlp-agentic-ai/agentic_ai_governance_concerns.png}
\end{frame}

\begin{frame}{Safety in Agentic Systems}
  \begin{center}
    \includegraphics[width=0.8\textwidth,height=0.8\textheight,keepaspectratio]{images/multimodal-nlp-agentic-ai/agentic_multiagent_coordination_architecture.png}
  \end{center}
{\small
...
\begin{frame}{Ethics and Control}
  \centering
  \includegraphics[width=0.8\textwidth,height=0.8\textheight,keepaspectratio]{images/multimodal-nlp-agentic-ai/agentic_ai_ethics_framework_guide.png}
\end{frame}
