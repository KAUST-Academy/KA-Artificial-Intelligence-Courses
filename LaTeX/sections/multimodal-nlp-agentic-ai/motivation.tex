...
\begin{frame}{What is multimodality?}
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.34\textwidth}
      \centering
      \includegraphics[width=0.7\textwidth, height=0.7\textheight, keepaspectratio]{images/multimodal-nlp-agentic-ai/multimodal_gaussian_surface_plot.png}
  \end{columns}
\end{frame}
...
\begin{frame}{Multimodal brains}
  ...
  \vspace{1em}
  \centering
  \includegraphics[width=0.50\textwidth, height=0.50\textheight, keepaspectratio]{images/multimodal-nlp-agentic-ai/multimodal_speaking_person_video_frame.png}
\end{frame}
