...
\begin{columns}
    \column{0.5\textwidth}
    \begin{center}
        \includegraphics[width=0.66\linewidth]{images/linear-regression/linear-regression-14.png} \\
        $\{1, x\}$
    \end{center}
    
    \column{0.5\textwidth}
    \begin{center}
        \includegraphics[width=0.66\linewidth]{images/linear-regression/linear-regression-15.png} \\
        $\{1, x, x^{[2]}, x^{[3]}, x^{[4]}\}$
    \end{center}
\end{columns}
...
\begin{columns}
    \column{0.5\textwidth}
    \begin{center}
        \includegraphics[width=0.66\linewidth]{images/linear-regression/linear-regression-16.png} \\
        $\{1, x, x^{[2]}, \dots, x^{[10]}\}$
    \end{center}
    
    \column{0.5\textwidth}
    \begin{center}
        \includegraphics[width=0.66\linewidth]{images/linear-regression/linear-regression-17.png} \\
        $\{1, x, x^{[2]}, \dots, x^{[100]}\}$
    \end{center}
\end{columns}
