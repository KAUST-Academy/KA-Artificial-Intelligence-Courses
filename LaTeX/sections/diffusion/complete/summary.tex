...
\begin{figure}
    \centering
    \includegraphics[height=0.9\textheight, width=\textwidth, keepaspectratio]{images/diffusion/gen_ai_landscape.jpg}
\end{figure}
\footnotetext{\href{https://www.sequoiacap.com/article/generative-ai-a-creative-new-world/}{Sonya Huang, Sequoia: ``Generative AI: A Creative New World''}}
\end{frame}

\begin{frame}{The Generative AI Landscape}
\begin{figure}
    \centering
    \includegraphics[height=0.9\textheight, width=\textwidth, keepaspectratio]{images/diffusion/gen_ai_landscape_2.jpg}
\end{figure}
\footnotetext{\href{https://www.sequoiacap.com/article/generative-ai-a-creative-new-world/}{Sonya Huang, Sequoia: ``Generative AI: A Creative New World''}}
\end{frame}
