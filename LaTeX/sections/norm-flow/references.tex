...
\framebreak
    ...
    Kobyzev, I., Prince, S. J. D., \& Brubaker, M. A. (2020).
    Normalizing Flows: An Introduction and Review of Current Methods.
    \textit{IEEE Transactions on Pattern Analysis and Machine Intelligence}, 43(11).

    % Continuous-time flows and Flow Matching (SOTA)
