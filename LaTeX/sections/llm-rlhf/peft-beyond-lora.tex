...
\begin{frame}[t]{The PEFT Family at a Glance}
  ...
  \end{center}
  \vspace{0.5em}
  {\scriptsize Each percentage is for the base model that method's own paper used (BERT-base, GPT-2, T5-XXL, T0-3B, LLaMA-7B) and at that paper's own rank or bottleneck size, so the column is indicative, not a controlled comparison.}
