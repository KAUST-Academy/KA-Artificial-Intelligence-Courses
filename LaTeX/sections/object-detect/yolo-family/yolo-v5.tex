...
\begin{frame}[allowframebreaks]{YOLOv5}
    \begin{figure}
        \centering
        \includegraphics[width=1.0\textwidth,height=0.76\textheight,keepaspectratio]{images/object-detect/yolo-v5.png}
        \caption*{\scriptsize Source: ``Overview of YOLOv5'' diagram by GitHub user seekFire, ultralytics/yolov5 issue \#280, 2020.}
    \end{figure}
\framebreak
