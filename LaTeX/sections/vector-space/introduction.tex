...
\begin{frame}{Why learn vector space models?}
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth,height=0.55\textheight,keepaspectratio]{images/vector-space/why-vector-space.png}
...
\begin{frame}{Vector Space Model Applications}
    ...
    \begin{figure}    \centering
        \includegraphics[width=\textwidth,height=0.65\textheight,keepaspectratio]{images/vector-space/vector-space-application.png}
        \caption*{\tiny Source: DeepLearning.AI, \textit{NLP with Classification and Vector Spaces} (Coursera), Week~3: Vector Space Models.}
    \end{figure}
\end{frame}
