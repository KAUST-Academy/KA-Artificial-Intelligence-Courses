...
\begin{itemize}
    ...
    \item[] {\small
      \[ \min_Q\;\; \alpha\big(
          \mathbb{E}_{a\sim\pi}[Q(s,a)] - \mathbb{E}_{a\sim\mathcal{D}}[Q(s,a)]
...
\begin{itemize}
    ...
    \item[] {\small
      \[ \min_Q\;\; \alpha\big(
          \mathbb{E}_{a\sim\pi}[Q(s,a)] - \mathbb{E}_{a\sim\mathcal{D}}[Q(s,a)]
        \big) + \mathcal{L}_{\mathrm{Bellman}} \]}
    \item $\min_Q$ = train $Q$ to make this small. The penalty is a
          \emph{difference}, so lowering it forces $Q$ \emph{down} on $\pi$'s (OOD)
          actions and \emph{up} on the data's actions
