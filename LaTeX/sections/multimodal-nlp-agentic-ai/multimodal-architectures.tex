...
\begin{frame}{Example Multimodal Architecture: Video Classification with Text, Audio, and Visual Streams}
  \begin{columns}
    ...
    \begin{column}{0.43\textwidth}
      \centering
      \includegraphics[width=0.8\textwidth, height=0.8\textheight, keepaspectratio]{images/multimodal-nlp-agentic-ai/multimodal_trimodal_text_audio_visual_fusion.png}
    \end{column}
  \end{columns}
  \vspace{0.4em}
  \scriptsize
  Adapted from: \textit{Multi-modal Learning for Video Classification}
\end{frame}
...
\begin{frame}{Categories of Multimodal Architectures}
  \includegraphics[width=0.98\textwidth, height=0.98\textheight, keepaspectratio]{images/multimodal-nlp-agentic-ai/multimodal_fusion_strategies_diagram.png}
\end{frame}

\begin{frame}{Early Fusion}
  \includegraphics[width=0.98\textwidth, height=0.98\textheight, keepaspectratio]{images/multimodal-nlp-agentic-ai/multimodal_text_image_fakenews_classifier.png}
\end{frame}

\begin{frame}{Late Fusion}
  \includegraphics[width=0.98\textwidth, height=0.98\textheight, keepaspectratio]{images/multimodal-nlp-agentic-ai/multimodal_gaze_gesture_data_fusion_cnn.png}
\end{frame}

\begin{frame}{Challenges in Multimodal Integration}
  \includegraphics[width=0.98\textwidth, height=0.98\textheight, keepaspectratio]{images/multimodal-nlp-agentic-ai/multimodal_learning_challenges.png}
\end{frame}
