...
\begin{columns}
    ...
    \begin{column}{0.5\textwidth}
        ...
        \caption*{\tiny Source: UMich EECS 498 (2019), Lecture 16: Detection and Segmentation, slide 68}
        \end{figure}
    \end{column}
\end{columns}
...
\begin{columns}
    \begin{column}{0.5\textwidth}
        \begin{itemize}
            \item \textbf{Object Detection:} Detects individual object instances, but only gives boxes (Only things!)
        \end{itemize}
        \begin{figure}
        \centering
        \includegraphics[width=0.95\textwidth,height=1.0\textheight,keepaspectratio]{images/segmentation/ins_2.png}
        \caption*{\tiny Source: UMich EECS 498 (2019), Lecture 16: Detection and Segmentation, slide 69}
        \end{figure}
    \end{column}
    \begin{column}{0.5\textwidth}
        \begin{itemize}
        ...
        \begin{figure}
        \centering
        \includegraphics[width=0.95\textwidth,height=1.0\textheight,keepaspectratio]{images/segmentation/ins_3.png}
        \caption*{\tiny Source: UMich EECS 498 (2019), Lecture 16: Detection and Segmentation, slide 69}
        \end{figure}
    \end{column}
\end{columns}
