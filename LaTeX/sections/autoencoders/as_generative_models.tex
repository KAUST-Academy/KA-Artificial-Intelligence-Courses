...
\begin{itemize}
    ...
    \item<3-> \textbf{Does not work}. Autoencoders just learn a function that maps input to output. The learned latent space is too discontinuous to work as a generative model.
...
\begin{figure}
    ...
    \caption*{Image generation with autoencoder trained on MNIST digits. Encoding vector sampled from latent space $Z$ and then passed to the decoder.}
\end{figure}
