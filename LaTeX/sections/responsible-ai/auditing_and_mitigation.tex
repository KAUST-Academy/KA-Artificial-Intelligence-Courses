...
\begin{frame}{Trade-offs, Monitoring, and Tooling}
    ...
    \begin{block}{}
        \centering
        \small \textbf{Lab:} \texttt{Fairness\_Audit.ipynb} --- disaggregate on UCI Adult, show the
        parity/odds tension, apply threshold post-processing, and measure what it cost.
    \end{block}
\end{frame}
