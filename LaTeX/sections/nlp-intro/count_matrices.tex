...
\begin{frame}{From Probability Matrix to Language Model}
    A \textbf{language model} assigns a probability to any sequence of words. The
    probability matrix is one: read a row to predict the next word, multiply along a
    path to score a whole sentence.
    \begin{figure}
        \centering
        \includegraphics[height=0.62\textheight,width=\textwidth,keepaspectratio]{images/nlp-intro/language-model.png}
        \caption*{\scriptsize Source: DeepLearning.AI, \textit{NLP with Probabilistic Models}, Week 3 slides.}
    \end{figure}
\end{frame}
