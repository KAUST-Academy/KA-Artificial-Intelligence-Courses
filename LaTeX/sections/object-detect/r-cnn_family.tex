...
\begin{frame}[allowframebreaks]{R-CNN Family}
    \begin{figure}
        ...
        \caption*{\scriptsize Source: Lilian Weng, ``Object Detection for Dummies Part 3: R-CNN Family'', lilianweng.github.io, 2017.}
    \end{figure}
...
\input{sections/object-detect/r-cnn-family/mask-r-cnn}