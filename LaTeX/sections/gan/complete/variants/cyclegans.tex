...
\begin{itemize}
    \item Unpaired Image-to-Image Translation using Cycle-Consistent Adversarial Networks, Zhu, Park, Isola, Efros, ICCV 2017
...
\begin{itemize}
    ...
    \item For $x \in X$: $x \rightarrow G(x) = \hat{y} \rightarrow F(\hat{y}) \approx x$
...
\begin{figure}
    ...
    \caption*{\scriptsize [Source: J. Brownlee, ``How to Develop a CycleGAN for Image-to-Image Translation with Keras,'' MachineLearningMastery.com]}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[height=0.8\textheight, width=\textwidth, keepaspectratio]{images/gan/cycle_gan_4.png}
    \caption*{\scriptsize [Source: J. Brownlee, ``How to Develop a CycleGAN for Image-to-Image Translation with Keras,'' MachineLearningMastery.com]}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[height=0.8\textheight, width=\textwidth, keepaspectratio]{images/gan/cycle_gan_5.png}
    \caption*{\scriptsize [Source: J. Brownlee, ``How to Develop a CycleGAN for Image-to-Image Translation with Keras,'' MachineLearningMastery.com]}
\end{figure}
...
\begin{figure}
    ...
    \caption*{Image to Image translation with Cycle GANs. {\scriptsize [Zhu, Park, Isola \& Efros, ICCV 2017, Fig.~1]}}
\end{figure}
\end{frame}