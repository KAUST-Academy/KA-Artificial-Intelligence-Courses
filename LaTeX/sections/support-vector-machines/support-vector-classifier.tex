...
\begin{frame}{Bias, Variance and $C$}
    \begin{columns}
        ...
        \begin{column}{0.55\textwidth}
            \centering
            \includegraphics[width=0.97\textwidth,keepaspectratio]{images/support-vector-machines/support-vector-machines-14.png}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Bias, Variance and $C$}     
    \begin{columns}         
        ...
        \begin{column}{0.55\textwidth}             
            \centering             
            \includegraphics[width=0.85\textwidth,keepaspectratio]{images/support-vector-machines/support-vector-machines-15.png}         
        \end{column}     
    \end{columns}
    \begin{center}
