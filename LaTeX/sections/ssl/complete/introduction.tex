...
\begin{frame}[allowframebreaks]{Introduction}
    \begin{figure}
        \centering
        \includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/ssl/slide_2_1_img.png}
    \end{figure}
    {\footnotesize Source: Goodfellow, Bengio \& Courville, \emph{Deep Learning}, MIT Press, 2016, Fig.~1.1.}
    ...
    \begin{column}{0.45\textwidth}
        \begin{figure}
            \flushleft
            \includegraphics[width=\linewidth,height=0.72\textheight,keepaspectratio]{images/ssl/slide_3_1_img.png}
        \end{figure}
        {\footnotesize Source: Goodfellow, Bengio \& Courville, \emph{Deep Learning}, MIT Press, 2016, Fig.~1.4.}
    \end{column}
    ...
    \begin{column}{0.38\textwidth}
        \begin{figure}
            \flushleft
            \includegraphics[width=\linewidth,height=0.55\textheight,keepaspectratio]{images/ssl/slide_3_1_img.png}
        \end{figure}
        {\footnotesize Source: Goodfellow, Bengio \& Courville, \emph{Deep Learning}, MIT Press, 2016, Fig.~1.4.}
    \end{column}
    \begin{column}{0.6\textwidth}
        ...
        \begin{itemize}
            ...
            \item Often used interchangeably with unsupervised learning, but SSL specifically focuses on using the data's intrinsic structure.
        \end{itemize}
    \end{column}
    \end{columns} 
\end{frame}
...
\begin{frame}[allowframebreaks]{Why Self-Supervised Learning?}
    \begin{itemize}
        ...
        \item \textbf{Use unlabeled data:} The internet provides vast amounts of unlabeled images, videos, and text.
    ...
    \begin{column}{0.42\textwidth}
        \textit{“Give a robot a label and you feed it for a second; teach a robot to label and you feed it for a lifetime.”} \\
        \hspace*{\fill}--- Pierre Sermanet

        \vspace{1em}

        \small
        This quote captures the core motivation behind self-supervised learning: machines that generate their own supervision from data reduce the reliance on costly manual labeling, and can keep learning at scale.
    \end{column}
    \end{columns} 
\end{frame}
...
\begin{frame}[allowframebreaks]{What is Self-Supervised Learning?}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/ssl/slide_10_1_img.png}
    \end{figure}
    {\footnotesize Source: Y. LeCun, ``Energy-Based Approaches to Representation Learning,'' Institute for Advanced Study, 16 Oct 2019, slide 13.}
