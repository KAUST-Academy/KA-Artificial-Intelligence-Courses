...
%     \column{0.6\textwidth}
%     \centering
%     \includegraphics[width=0.8\linewidth, height=0.8\textheight, keepaspectratio]{images/jepa/
...
\begin{frame}{V-JEPA: Results, and Limitations}
  ...
  \end{itemize}
  \centering
  \includegraphics[width=0.8\linewidth, height=0.5\textheight, keepaspectratio]{images/jepa/vjepa_blog_eval_chart.png}\\[0.25em]
