...
% MAE itself is not taught elsewhere in the course; this grounds the
% "generative / reconstruction" family that JEPA is contrasted against.
...
\begin{frame}{The Collapse Problem and How JEPA Avoids It}
  \begin{itemize}\itemsep0.25em
    ...
    \item Three families of \textbf{anti-collapse mechanisms} (covered earlier):
