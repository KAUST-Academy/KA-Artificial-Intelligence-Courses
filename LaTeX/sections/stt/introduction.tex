...
\begin{frame}{Introducing the speech recognition task}
  ...
  \footnotesize\href{https://catalog.ldc.upenn.edu/LDC97S62}{Switchboard corpus} conversation example
\end{frame}
...
\begin{frame}{History: Foundational Insights 1900s--1950s}
  \textbf{Automaton:}
  \begin{itemize}
    \item Markov 1906 (chains), 1913 (letter sequences in \textit{Eugene Onegin})
    \item Turing 1936
...
\begin{frame}{Early Recognition: 1920's Radio Rex}
  \begin{columns}
    ...
    \centering
    \includegraphics[width=0.95\textwidth]{images/stt/stt_radio_rex_history.png} \\
    \vspace{0.5em}
    {\scriptsize\textit{Radio Rex toy and box (c. 1920s)}}
    \slideimgsource{Stanford CS224S, Lecture 9 (2025 Spring), slide 46.}
    ...
    \begin{itemize}
      ...
      \item Any sound with enough energy near 500 Hz sets it off, so this is energy detection rather than word recognition
    \end{itemize}
  \end{columns}
\end{frame}
...
\begin{frame}{ASR: 1950's -- Early Speech Recognizers}
  \begin{itemize}
    ...
    \end{itemize}
    \item \textbf{1958:} Dudley \& Balashek built classifier that used continuous spectrum rather than just formants
    \item \textbf{1959:} Fry \& Denes (UCL) ASR combining phoneme-sequence statistics and acoustic probability
  \end{itemize}
\end{frame}
...
\begin{frame}{Recent ASR Improvements}
  \centering
  \includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{images/stt/stt_asr_benchmark_results.png}
  \slideimgsource{Excerpt of the WER progress tables at \href{https://github.com/syhw/wer_are_we}{github.com/syhw/wer\_are\_we} (Synnaeve); via Stanford CS224S, Lecture 9 (2025 Spring), slide 52.}
\end{frame}
