...
\begin{frame}[allowframebreaks]{Spatio-Temporal Self-Attention (Nonlocal Block)}
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth,height=0.82\textheight,keepaspectratio]{images/video/slide_33_1_img.jpg}
        \caption*{\tiny [Source: UMich EECS 498 (2022), Lecture 24: Videos, slide 72]}
    \end{figure}
\framebreak
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth,height=0.82\textheight,keepaspectratio]{images/video/slide_34_1_img.jpg}
        \caption*{\tiny [Source: UMich EECS 498 (2022), Lecture 24: Videos, slide 74]}
    \end{figure}
\end{frame}