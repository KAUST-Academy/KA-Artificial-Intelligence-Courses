...
\begin{frame}{Where We Left Off}
    ...
    \begin{block}{Already covered in Day~1 (Data Science Foundations)}
        What a hyperparameter is; structural versus optimisation hyperparameters; \textbf{grid search} and
        \textbf{random search} over a validation split. We will not repeat that here.
    \end{block}
    ...
    \begin{alertblock}{The gap}
        Both methods are \textbf{memoryless}: trial 90 knows nothing about trials 1--89, and a trial that is
        obviously hopeless at epoch 2 still runs to epoch 50. This section fixes both --- with
        \textbf{Bayesian search} and \textbf{pruning}.
    \end{alertblock}
