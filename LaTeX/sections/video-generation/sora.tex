...
\begin{frame}{A Brief History: From Texture Synthesis to Sora}
  \centering
  \includegraphics[width=\linewidth,height=0.56\textheight,keepaspectratio]{images/video-generation/genai_vision_history.png}
  \footnotesize
  \begin{itemize}\footnotesize
...
\begin{frame}[t,allowframebreaks]{Sora Core: Diffusion Transformer Architecture}
  \centering
  \includegraphics[width=\linewidth,height=0.78\textheight,keepaspectratio]{images/video-generation/sora_arxiv2402177_p06_fig4_framework.png}\\[0.12em]
  \begin{itemize}\footnotesize
