...
\begin{frame}{How to Create Vocabulary $V$}
    ...
    \vspace{1em}
    \textbf{Caution:} A large \texttt{<UNK>} rate makes a model look good on its own terms, because predicting one frequent token is easy. Two models are only comparable if they were built with the same vocabulary $V$.
\end{frame}