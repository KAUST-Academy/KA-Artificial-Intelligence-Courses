...
\begin{itemize}
    ...
    \item \textbf{Diffusion models (covered in the diffusion lecture):} learn to reverse a gradual noising process; sampling follows a \textbf{curved} path and traditionally needs many steps.
...
\begin{itemize}
    \item \textbf{Stable Diffusion 3} (Esser et al., 2024): a rectified-flow transformer; the paper's ablations found that the linear flow-matching path outperforms diffusion-style objectives at scale for text-to-image generation.
