...
\begin{columns}
    ...
    \begin{column}{0.55\textwidth}
        \begin{figure}
            \centering
            \includegraphics[width=0.95\textwidth,height=0.62\textheight,keepaspectratio]{images/dul/hierarchical/dendrograms.png}
            \caption{James, Witten, Hastie \& Tibshirani, \emph{An Introduction to Statistical Learning} (ISL), 8th printing 2017}
        \end{figure}
    \end{column}
\end{columns}
...
\begin{block}{}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.95\textwidth,height=0.55\textheight,keepaspectratio]{images/dul/hierarchical/dendograms-distance-metric.png}
...
\begin{columns}
    ...
    \begin{column}{0.55\textwidth}
        \begin{figure}
            \centering
            \includegraphics[width=1.0\textwidth,height=0.62\textheight,keepaspectratio]{images/dul/hierarchical/dendrograms-cluster.png}
            \caption{ISL (8th printing 2017)}
        \end{figure}
    \end{column}
\end{columns}
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\textwidth,height=0.7\textheight,keepaspectratio]{images/dul/hierarchical/dendrogram-interpretation.png}
...
\begin{block}{Distance between groups}
    ...
    \vspace{0.8em}
    \textbf{Linkage}: defines the dissimilarity between two groups of observations.  Most common types are \textit{complete}, \textit{average}, \textit{single}, and \textit{centroid}.
\end{block}
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\textwidth,height=0.72\textheight,keepaspectratio]{images/dul/hierarchical/linkage.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\textwidth,height=0.72\textheight,keepaspectratio]{images/dul/hierarchical/dendrogram-linkage-types.png}
    \caption{Dendrogram with different linkage types. [ISL Fig.~10.12 (8th printing 2017),
...
\begin{columns}
    ...
    \begin{column}{0.5\textwidth}
        ...
        \begin{itemize}
            ...
            \item Must choose where to cut the dendrogram, and the cut height that gives the best clusters is not obvious.
