...
\begin{frame}{U-Net: A Natural Architecture for Image-to-Image Functions}
    \centering
    \includegraphics[width=0.8\linewidth,height=0.6\textheight,keepaspectratio]{images/stable-diffusion/unet.png}
\end{frame}
...
\begin{frame}{Note: Add Time Dependency}
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.46\textwidth}
      ...
      \includegraphics[width=0.96\linewidth,height=0.7\textheight,keepaspectratio]{images/stable-diffusion/add_time_dimension.png}
  \end{columns}
\end{frame}
...
\begin{frame}[allowframebreaks]{U-Net in Stable Diffusion}
  \begin{columns}[T,onlytextwidth]
    \column{0.44\textwidth}
      ...
      \includegraphics[width=0.99\linewidth,keepaspectratio]{images/stable-diffusion/attention.png}\\[0.25em]
