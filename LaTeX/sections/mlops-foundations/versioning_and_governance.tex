...
\begin{frame}{Lineage: Answering ``Where Did This Number Come From?''}
    ...
    \begin{itemize}
        ...
        \item \textbf{Two questions a customer, a reviewer or your own on-call will ask:} which model
...
\begin{frame}{Documentation and the Hand-off to Governance}
    ...
    \vspace{0.12em}
    {\scriptsize \textbf{Hand-off:} bias auditing, fairness definitions and interpretability belong
    to the responsible-AI material seen earlier. MLOps supplies the \emph{mechanisms} --- lineage,
    prediction logs, versioned artifacts --- that make those commitments enforceable rather than aspirational.}
