\begin{frame}[allowframebreaks]{Denoising}
    ...
    \begin{figure}
        \centering
        \fetchconvertimage{https://wikidocs.net/images/page/193827/Autoencoders-to-Image-Denoising.png}{images/autoencoder/denoising.png}{width=\textwidth,height=0.72\textheight,keepaspectratio}
        \caption*{Example of denoising using an autoencoder.\\ {\scriptsize Source: \url{https://wikidocs.net/193827}}}
    \end{figure}
\end{frame}