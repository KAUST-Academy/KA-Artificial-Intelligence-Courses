...
\begin{frame}{BERT -- Bidirectional Encoder Representations}
  \centering
  \includegraphics[width=0.8\paperwidth,height=0.8\paperheight,keepaspectratio]{assets/Lecture-7_Large_Language_Models/pdf_page_011.png}
\end{frame}

\begin{frame}{BERT -- Bidirectional Encoder Representations}
  \centering
  \includegraphics[width=0.8\paperwidth,height=0.8\paperheight,keepaspectratio]{assets/Lecture-7_Large_Language_Models/pdf_page_012.png}
\end{frame}
...
\begin{frame}{BERT -- Bidirectional Encoder Representations}
  \centering
  \includegraphics[width=0.9\paperwidth,height=0.9\paperheight,keepaspectratio]{assets/Lecture-7_Large_Language_Models/pdf_page_015.png}
\end{frame}
...
\begin{frame}{GPT -- Generative Pre-trained Transformer}
  \begin{columns}
    ...
    \begin{column}{0.38\textwidth}
      ...
      \vspace{0.5em}
      \centering
      \includegraphics[width=0.8\linewidth, height=0.8\paperheight, keepaspectratio]{assets/Lecture-7_Large_Language_Models/pdf_page_020.png}
    \end{column}
  \end{columns}
\end{frame}
