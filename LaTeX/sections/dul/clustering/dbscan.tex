...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item HDBSCAN (Hierarchical Density-Based Spatial Clustering of Applications with Noise): Campello, et al. (ACM TKDD’15)
        \item DENCLUE (DENsity-based CLUstEring): Hinneburg and Keim (KDD’98)
        \item CLIQUE (CLustering In QUEst): Agrawal, et al. (SIGMOD’98)
    \end{itemize}
\end{itemize}
\end{frame}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item A point is a core point if it has at least MinPts points within $\epsilon$ (including itself). These are points that are at the interior of a cluster.
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\textwidth,height=0.66\textheight,keepaspectratio]{images/dul/dbscan/dbscan-features.png}
    \caption{DBSCAN features: Core, Border, and Noise Points [Tan, Steinbach \& Kumar,
    \emph{Introduction to Data Mining}, via C. F. Eick, Machine Learning, Univ. of Houston]}
\end{figure}
\end{frame}
...
\begin{columns}
    \begin{column}{0.5\textwidth}
       \begin{figure}
            \centering
            \includegraphics[width=0.82\textwidth,height=0.42\textheight,keepaspectratio]{images/dul/dbscan/dbscan-original-pts-1.png}
    ...
    \begin{column}{0.5\textwidth}
        \begin{figure}
            \centering
            \includegraphics[width=0.82\textwidth,height=0.42\textheight,keepaspectratio]{images/dul/dbscan/dbscan-core-border-noise.png}
            \caption{Point types: \textcolor{green}{Core}, \textcolor{blue}{Border}, and \textcolor{red}{Noise} Points [Tan, Steinbach \& Kumar, \emph{Introduction to Data Mining}]}
        \end{figure}
    \end{column}
\end{columns}
...
\begin{columns}
    ...
    \begin{column}{0.5\textwidth}
        \begin{figure}
            \centering
            \includegraphics[width=0.82\textwidth,height=0.42\textheight,keepaspectratio]{images/dul/dbscan/dbscan-clusters.png}
...
\centering
{\scriptsize [Tan, Steinbach \& Kumar, \emph{Introduction to Data Mining}, via C. F. Eick, Machine Learning, Univ. of Houston]}
\end{frame}

\begin{frame}[allowframebreaks]{When DBSCAN Doesn't Work Well}
\begin{columns}
    \begin{column}{0.5\textwidth}
       \begin{figure}
            \centering
...
\begin{figure}
    \centering
    \includegraphics[height=0.58\textheight,keepaspectratio]{images/dul/dbscan/eps-determination.png}
    \caption{Sorted 4-nearest-neighbour distance plot (MinPts=4); the knee gives $\epsilon$
    [Tan, Steinbach \& Kumar, \emph{Introduction to Data Mining}; core/non-core annotation from
    C. F. Eick, Machine Learning, Univ. of Houston]}
\end{figure}
\end{frame}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Has problems identifying clusters of varying densities (\textrightarrow{} SNN (Shared Nearest Neighbour) algorithm).
...
\begin{figure}
    \centering
    \includegraphics[height=0.66\textheight,keepaspectratio]{images/dul/dbscan/algorithm.png}
    \caption{DBSCAN Algorithm Steps [Tan, Steinbach \& Kumar, \emph{Introduction to Data Mining},
    via C. F. Eick, Machine Learning, Univ. of Houston]}
\end{figure}
\end{frame}