...
\begin{frame}{FlashAttention: The Core Idea}
    \begin{itemize}\itemsep0.4em
        ...
        \item On-chip SRAM is roughly an order of magnitude faster than HBM but only megabytes in size.
...
\begin{frame}{FlashAttention-2: Overview}
    \begin{itemize}
        ...
        \begin{itemize}
            \item Up to 73\% of theoretical peak FLOPs (72\% model FLOPs utilization on A100)
...
\framebreak
    \begin{itemize}
        \item \textbf{MQA and GQA Support:} Works with the shared-KV attention variants from the previous section, combining kernel speed with a smaller cache.
