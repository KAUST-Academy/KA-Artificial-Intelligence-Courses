...
\begin{frame}[allowframebreaks]{So UMAP is great then?}
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth,height=0.64\textheight,keepaspectratio]{images/dul/dim-reduce/slide_42_1_img.png}
        \caption*{\scriptsize [Source: S. Andrews, ``Dimension Reduction'', Babraham Bioinformatics]}
    \end{figure}
\end{frame}
...
\begin{frame}[allowframebreaks]{So UMAP is all hype then?}
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth,height=0.58\textheight,keepaspectratio]{images/dul/dim-reduce/slide_43_1_img.png}
        \caption*{\scriptsize [Mammoth projections from \url{https://pair-code.github.io/understanding-umap/},
...
\begin{frame}[allowframebreaks]{So PCA + UMAP is great then?}
    ...
    \begin{column}{0.6\textwidth}
        \begin{figure}
            ...
            \caption{UMAP [Source: S. Andrews, ``Dimension Reduction'', Babraham Bioinformatics]}
        \end{figure}
    \end{column}
    \end{columns}
\end{frame}