...
\begin{itemize}
    ...
    \]
    \item \textbf{Modern practice:} the autoencoders behind large generative systems (VQGAN, Stable Diffusion's VAE) combine pixel, \textbf{perceptual (LPIPS)}, and \textbf{adversarial} losses to stay sharp at strong compression.
