...
\framebreak
    \begin{columns}[T,onlytextwidth]
        ...
        \begin{column}{0.35\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\linewidth,height=0.78\textheight,keepaspectratio]{images/video/slide_19_1_img.png}
                \caption*{\tiny [Source: UMich EECS 498 (2022), Lecture 24: Videos, slide 38]}
            \end{figure}
        \end{column}
    \end{columns}
\framebreak
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth,height=0.82\textheight,keepaspectratio]{images/video/slide_20_1_img.jpg}
        \caption*{\tiny [Source: UMich EECS 498 (2022), Lecture 24: Videos, slide 40]}
    \end{figure}
\end{frame}