...
\begin{frame}{Understanding LLM Inference}
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.46\textwidth}
      \centering
      \includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/introduction-to-transformers/transformer_variant_decoder_only_alt_highlighted.png}
  \end{columns}
\end{frame}
...
\begin{frame}{Prefill Phase: Parallel Input Processing}
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.44\textwidth}
      \centering
      \includegraphics[width=\linewidth,height=0.8\paperheight,keepaspectratio]{images/introduction-to-transformers/transformer_variant_decoder_only_alt_highlighted.png}
  \end{columns}
\end{frame}
...
\begin{frame}{Decode Phase: Serial Token Generation}
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.45\textwidth}
      \centering
      \includegraphics[width=0.9\linewidth,height=0.75\paperheight,keepaspectratio]{images/introduction-to-transformers/transformer_variant_decoder_only_alt_highlighted.png}
  \end{columns}
\end{frame}
...
%     \column{0.46\textwidth}
%     \centering
%     \includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/inference-optimisation/transformer_scaled_dotproduct_multihead_attention.png}\\[-0.2em]
...
%     \column{0.5\textwidth}
%     \centering
%     \includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/inference-optimisation/transformer_architecture_encoder_decoder.png}\\[-0.2em]
