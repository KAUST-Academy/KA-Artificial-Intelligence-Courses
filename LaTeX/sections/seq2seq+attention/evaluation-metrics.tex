...
\begin{itemize}
    ...
    Takes the minimum number of edits (insertions, deletions, substitutions, and shifts of word sequences) needed to match the reference, divided by the average reference length.
