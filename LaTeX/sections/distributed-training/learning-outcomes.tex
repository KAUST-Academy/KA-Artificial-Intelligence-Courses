...
\begin{frame}{Learning Outcomes}
  ...
  \begin{itemize}\footnotesize
    \item[\textcolor{red}{$\blacktriangleright$}] \textbf{Assumed background:} the transformer block (deck 06), scaling laws (deck 07), and single-node inference optimisation --- KV caching, continuous batching, quantization (deck 17).
  \end{itemize}
\end{frame}
