...
\begin{frame}{Motivation}
    \begin{itemize}
        ...
        \item \textbf{Autoencoders} are a type of \textbf{unsupervised learning} model used for compression and representation learning; the desire to also \emph{generate} new data motivates VAEs later in this lecture.
