...
\begin{frame}{What is Sound?}
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth,height=0.48\textheight,keepaspectratio]{images/audio-nlp/sound-waves.png}
        \caption*{\scriptsize Source: Let's Talk Science, ``What is Sound and How do we Hear it?''}
    \end{figure}
    \begin{itemize}
...
\begin{frame}[allowframebreaks]{Fundamentals of Sound: Physics Concepts}
    \begin{figure}
        ...
        \caption*{\scriptsize Source: \href{https://openlab.citytech.cuny.edu/comd1112-fall2020-noriega/sound-and-audio/}{``Sound and Audio,'' COMD1112, OpenLab at City Tech, CUNY}}
    \end{figure}
    \begin{itemize}
...
\framebreak
    ...
    \end{itemize}
    \vspace{0.5em}
    The result is a \textbf{discrete signal}, denoted as $x[n]$, which is a sequence of numbers representing the original analog signal.
\framebreak
...
\begin{frame}[allowframebreaks]{Digitizing speech: sampling, quantization, bitrate}
    ...
    \begin{center}
        ...
        {\scriptsize Source: Wikipedia, ``Nyquist rate''.}
    \end{center}
\framebreak
    \begin{itemize}
        ...
        \begin{center}
            \includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{images/audio-nlp/aliasing.png}\\
            {\scriptsize Source: M. Waldrep (Dr.~AIX), ``Aliasing and Foldover: A Primer,'' Real HD-Audio, 2014.}
        \end{center}
    \end{itemize}
\framebreak
    \begin{itemize}
