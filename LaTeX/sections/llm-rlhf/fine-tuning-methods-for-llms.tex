...
\begin{frame}{Full Fine-Tuning Workflow}
  \includegraphics[width=0.8\paperwidth,height=0.8\paperheight,keepaspectratio]{assets/Lecture-8_Fine_Tuning_RLHF/slide_010.png}
\end{frame}
...
\begin{frame}{Parameter-Efficient Fine-Tuning (PEFT)}
  \centering
  \includegraphics[width=0.8\paperwidth,height=0.8\paperheight,keepaspectratio]{assets/Lecture-8_Fine_Tuning_RLHF/slide_012.png}
\end{frame}
