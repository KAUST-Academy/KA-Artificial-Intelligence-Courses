...
\begin{frame}{The Problem: Long-Term Dependencies}
    \begin{itemize}
        ...
        \item Gradients tend to \textbf{vanish} (shrink to zero) or \textbf{explode} over
              long sequences.
...
\begin{frame}{LSTM vs GRU}
    \begin{figure}
        ...
        \caption*{\tiny Source: \href{https://medium.com/data-science/illustrated-guide-to-lstms-and-gru-s-a-step-by-step-explanation-44e9eb85bf21}{Illustrated Guide to LSTM's and GRU's: A step by step explanation}}
    \end{figure}
\end{frame}
...
\begin{frame}{LSTM vs GRU}
    ...
    \begin{itemize}
        ...
        \item The choice is empirical --- GRU is a strong, cheaper default; LSTM can edge
              ahead on hard tasks.
    \end{itemize}
\end{frame}
