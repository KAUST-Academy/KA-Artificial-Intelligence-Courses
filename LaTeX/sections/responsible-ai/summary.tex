...
\begin{frame}{What to Take Away}
    ...
    \begin{itemize}
        ...
        \item \textbf{Documentation is the deliverable.} The model card and the audit are what a
              reviewer, a customer, or the engineer who inherits the model will actually read.
              Everything else in this lecture lasts only as long as what you wrote down.
    \end{itemize}
\end{frame}
