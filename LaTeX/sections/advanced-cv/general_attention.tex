...
\begin{frame}{}
    \LARGE Transformers: \textbf{General Attention Layer}
\end{frame}

\begin{frame}{Attention We Just Saw in Image Captioning}
\begin{figure}
\centering
\includegraphics[width=1.0\textwidth,height=0.80\textheight,keepaspectratio]{images/advanced-cv/attention_20.png}
...
\begin{columns}
    ...
    \begin{figure}
    \centering
    \includegraphics[width=1.0\textwidth,height=0.80\textheight,keepaspectratio]{images/advanced-cv/attention_21.png}
    \caption*{\tiny Source: Stanford CS231n (2022), Lecture 11: Attention and Transformers}
    \end{figure}
    }
    ...
    \begin{figure}
    \centering
    \includegraphics[width=1.0\textwidth,height=0.80\textheight,keepaspectratio]{images/advanced-cv/attention_22.png}
    \caption*{\tiny Source: Stanford CS231n (2022), Lecture 11: Attention and Transformers}
    \end{figure}
    }
    ...
    \begin{figure}
    \centering
    \includegraphics[width=1.0\textwidth,height=0.80\textheight,keepaspectratio]{images/advanced-cv/attention_23.png}
    \caption*{\tiny Source: Stanford CS231n (2022), Lecture 11: Attention and Transformers}
    \end{figure}
    }
    ...
    \begin{figure}
    \centering
    \includegraphics[width=1.0\textwidth,height=0.80\textheight,keepaspectratio]{images/advanced-cv/attention_24.png}
    \caption*{\tiny Source: Stanford CS231n (2022), Lecture 11: Attention and Transformers}
    \end{figure}
    }
    ...
    \begin{figure}
    \centering
    \includegraphics[width=1.0\textwidth,height=0.80\textheight,keepaspectratio]{images/advanced-cv/attention_25.png}
    \caption*{\tiny Source: Stanford CS231n (2022), Lecture 11: Attention and Transformers}
    \end{figure}
    }
    ...
    \begin{figure}
    \centering
    \includegraphics[width=1.0\textwidth,height=0.80\textheight,keepaspectratio]{images/advanced-cv/attention_26.png}
    \caption*{\tiny Source: Stanford CS231n (2022), Lecture 11: Attention and Transformers}
    \end{figure}
    }
