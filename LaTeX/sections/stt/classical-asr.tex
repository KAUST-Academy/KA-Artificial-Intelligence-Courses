...
\begin{frame}{Classical ASR: The Noisy Channel Model}
  ...
  \end{itemize}
  \begin{center}
    \includegraphics[width=\textwidth,height=0.92\textheight,keepaspectratio]{images/stt/stt_noisy_channel_model.png}
  \end{center}
\end{frame}
...
\begin{frame}{The Noisy Channel Model}
  \centering
\includegraphics[width=\textwidth,height=0.92\textheight,keepaspectratio]{images/stt/stt_noisy_channel_equation.png}
\end{frame}

% --- Stanford CS224S lec9, slide 11 ---
\begin{frame}{Word error rate (WER)}
\centering
\includegraphics[width=\textwidth,height=0.92\textheight,keepaspectratio]{images/stt/stt_word_error_rate.png}
\end{frame}

\begin{frame}{Speech Recognition Architecture}
  \centering
  \includegraphics[width=\textwidth,height=0.92\textheight,keepaspectratio]{images/stt/stt_asr_architecture.png}
\end{frame}
...
\begin{frame}{Classical ASR:HMM-GMM system}
  \centering
  \includegraphics[width=\textwidth,height=0.92\textheight,keepaspectratio]{images/stt/stt_hmm_gmm_phones.png}
\end{frame}
