...
\begin{tcolorbox}[colback=blue!5, colframe=blue!50, height=2.6cm]
\textbf{1. Clustering}
...
\begin{tcolorbox}[colback=red!5, colframe=red!50, height=2.6cm]
...
\begin{column}{0.50\textwidth}
\begin{tcolorbox}[colback=orange!5, colframe=orange!50, height=2.6cm]
...
\begin{tcolorbox}[colback=purple!5, colframe=purple!50, height=2.6cm]
\textbf{4. Generation}
