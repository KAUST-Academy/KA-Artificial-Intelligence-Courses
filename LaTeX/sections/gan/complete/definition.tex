...
\begin{itemize}
    \item Let $S_1 = \{x \sim p_{\text{data}}\}$ and $S_2 = \{x \sim p_\theta\}$.
...
\begin{figure}
    ...
    \caption*{The generator transforms a simple distribution into samples resembling real data. The discriminator distinguishes between real and fake samples. {\scriptsize [Source: F. Fleuret, ``Deep Learning'' (EE-559), 11.1 Generative Adversarial Networks]}}
\end{figure}
\end{frame}