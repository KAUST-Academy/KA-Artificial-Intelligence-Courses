% --- Customization ecosystem: why open weights mattered ---
...
% Deep-dives relocated from the former fine-tuning section of the
% Advanced Image Generation deck (16 owns customization).
\input{sections/stable-diffusion/dreambooth}
\input{sections/stable-diffusion/lora}
