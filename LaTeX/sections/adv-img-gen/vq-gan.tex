...
\framebreak
    \begin{figure}
        \centering
        \includegraphics[width=1\textwidth,height=0.85\textheight,keepaspectratio]{images/video/slide_59_1_img.jpg}
    \end{figure}
    {\footnotesize{[Taming Transformers for High-Resolution Image Synthesis, Esser, Rombach \& Ommer, CVPR 2021]}}
\end{frame}
