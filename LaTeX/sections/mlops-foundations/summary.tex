...
\begin{frame}{Where to Practise This}
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            \begin{tcolorbox}[colback=gray!8, colframe=gray!60, title=\small Lab 1 --- Tracking and tuning]
                \small
        ...
        \end{column}
        \begin{column}{0.48\textwidth}
            \begin{tcolorbox}[colback=gray!8, colframe=gray!60, title=\small Lab 2 --- Serving and drift]
                \small
    ...
    \begin{itemize}
        ...
        \item \textbf{Adjacent decks:} \textit{Responsible AI \& Model Interpretability} for governance,
              model cards and fairness auditing; \textit{Practical Deep Learning} (CV~02) for the
              training-loop reproducibility mechanics; and, in the NLP course, \textit{Inference
              Optimisation} and \textit{Distributed Training \& Serving} for models too large for a single CPU.
    \end{itemize}
