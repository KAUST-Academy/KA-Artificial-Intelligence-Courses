...
\begin{frame}{What is LoRA?}  
  \centering
  \includegraphics[width=0.8\paperwidth,height=0.8\paperheight,keepaspectratio]{assets/Lecture-8_Fine_Tuning_RLHF/slide_034.png}
\end{frame}
...
\begin{frame}{QLoRA --- Quantized LoRA}
  \centering
  \includegraphics[width=0.8\paperwidth,height=0.8\paperheight,keepaspectratio]{assets/Lecture-8_Fine_Tuning_RLHF/slide_037.png}
\end{frame}

\begin{frame}{QLoRA --- Quantized LoRA}
  \centering
  \includegraphics[width=0.8\paperwidth,height=0.8\paperheight,keepaspectratio]{assets/Lecture-8_Fine_Tuning_RLHF/slide_038.png}
\end{frame}
