% --- References (from sections/diffusion/complete/references.tex) ---
\section{References}
...
\begin{itemize}
    ...
    \item Binxu Wang: \href{https://binxuw.scholars.harvard.edu/sites/g/files/omnuum11221/files/binxuw/files/stable_diffusion_a_tutorial.pdf}{Stable Diffusion: A Tutorial (Harvard ML from Scratch)}
    \item Cornell CS4782 (2025): \href{https://www.cs.cornell.edu/courses/cs4782/2025sp/slides/pdf/week9_2_slides.pdf}{Diffusion Models II (Course Slides)}
\end{itemize}
