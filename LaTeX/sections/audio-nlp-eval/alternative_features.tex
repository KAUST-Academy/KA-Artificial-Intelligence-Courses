...
\begin{itemize}
    ...
    \item \textbf{Spectrogram-based Learned Features:} For large-scale, data-driven applications where a deep model has enough data to learn its own filters from the spectrogram.
