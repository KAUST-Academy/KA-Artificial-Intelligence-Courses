...
\framebreak
    \begin{figure}
        \centering
        \fetchconvertimage{https://towardsdatascience.com/wp-content/uploads/2022/09/1WTe5olMSFC-T6No0Y_gKWg.png}{images/diffusion/latent-space-diffusion-explained.png}{width=\textwidth,height=0.72\textheight,keepaspectratio}
        \caption*{\scriptsize Annotated by J. R. Siddiqui, \href{https://towardsdatascience.com/what-are-stable-diffusion-models-and-why-are-they-a-step-forward-for-image-generation-aa1182801d46/}{Towards Data Science}, 2022; base diagram: Rombach et al., CVPR 2022}
    \end{figure}
\framebreak
