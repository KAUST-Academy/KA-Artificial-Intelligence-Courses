...
\begin{frame}[allowframebreaks]{Forward Diffusion Process}
    ...
    \begin{figure}
        \centering
        \includegraphics[height=0.58\textheight, width=\textwidth, keepaspectratio]{images/diffusion/diff_2.png}
    ...
    \begin{itemize}
        ...
        \item Let $\alpha_t := 1-\beta_t$ and $\overline{\alpha}_t = \prod^t_{s=1}\alpha_s = \prod^t_{s=1}(1-\beta_s)$, then
