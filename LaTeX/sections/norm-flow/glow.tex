...
\begin{itemize}
    ...
    \item \textbf{ActNorm layers} for per-channel normalization with data-dependent initialization.
...
\begin{figure}
    ...
    \caption*{\tiny Source: Hao Dong, ``Deep Generative Models'' (Peking University), Normalising Flow Models Part~2, slide~23}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[height=0.78\textheight, width=\textwidth, keepaspectratio]{images/norm-flow/nfm_glow_1.png}
    \caption*{\tiny Source: Hao Dong, ``Deep Generative Models'' (Peking University), Normalising Flow Models Part~2, slide~24; after Hung-yi Lee, ``Flow-based Generative Model'' (NTU)}
\end{figure}
\end{frame}
...
\begin{figure}
    ...
    \caption*{Glow generated samples\\{\tiny Source: Kingma \& Dhariwal, ``Glow: Generative Flow with Invertible 1x1 Convolutions,'' NeurIPS 2018, Fig.~1.}}
\end{figure}
...
\begin{figure}
    ...
    \caption*{Linear interpolation in latent space between real images with Glow\\{\tiny Source: Kingma \& Dhariwal, ``Glow: Generative Flow with Invertible 1x1 Convolutions,'' NeurIPS 2018, Fig.~5.}}
\end{figure}
\end{frame}