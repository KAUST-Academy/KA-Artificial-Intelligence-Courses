...
\begin{frame}{Different Levels of Tokenization}
  \centering
  \includegraphics[width=0.8\paperwidth,height=0.8\paperheight,keepaspectratio]{assets/Lecture-7_Large_Language_Models/pdf_page_050.png}
\end{frame}

\begin{frame}{Different Levels of Tokenization}
  \centering
  \includegraphics[width=0.8\paperwidth,height=0.8\paperheight,keepaspectratio]{assets/Lecture-7_Large_Language_Models/pdf_page_051.png}
\end{frame}
