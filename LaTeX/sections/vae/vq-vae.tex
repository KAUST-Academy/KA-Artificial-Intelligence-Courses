...
\begin{itemize}
    ...
    \item \textbf{Why two stages?} It separates \textbf{perceptual compression} (stage 1) from \textbf{distribution modeling} (stage 2), and the prior works on a small token grid ($32 \times 32$) instead of $256^2$ pixels.
