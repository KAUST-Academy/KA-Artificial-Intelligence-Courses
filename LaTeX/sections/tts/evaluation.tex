...
\begin{frame}{Voice Cloning Safeguards}
  \begin{itemize}\itemsep0.4em
    ...
    \item \textbf{Detection:} train classifiers to spot synthetic speech; Voicebox shipped one alongside the model.
    \item These mitigations are partial: watermarks do not survive every re-encoding, and detectors lag the newest generators.
  \end{itemize}
\end{frame}
