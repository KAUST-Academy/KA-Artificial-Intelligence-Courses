...
\begin{frame}{Motivation}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item GANs (generative adversarial networks, covered later): Realistic samples, no likelihoods
