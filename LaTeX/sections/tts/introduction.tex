...
\begin{frame}{Exciting Recent Developments have Disrupted the Field}
  \centering
  \includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{images/tts/tts_history_timeline.png}
\end{frame}

% --- Source: Stanford CS224S, 224s.24.lec1.pdf, slide 5 ---
% \begin{frame}{Voice AI in the public eye (I)}
%   \centering
%   \includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{images/tts/tts_voice_clone_news_imran_khan.png}
...
%   \end{itemize}
%   \centering
%   \includegraphics[width=\textwidth,height=0.68\textheight,keepaspectratio]{images/tts/tts_conversational_speech_context.png}
...
%   \centering
%   \includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{images/tts/tts_human_vs_machine_errors.png}
...
%   \end{itemize}
%   \centering
%   \includegraphics[width=\textwidth,height=0.68\textheight,keepaspectratio]{images/tts/tts_accents_word_context.png}
...
%   \centering
%   \includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{images/tts/tts_is_asr_solved.png}
...
%   \end{itemize}
%   \centering
%   \includegraphics[width=\textwidth,height=0.65\textheight,keepaspectratio]{images/tts/tts_asr_design_intuition.png}
...
\begin{frame}{Snapshot: Task Oriented Dialogue Systems}
  \centering
  \includegraphics[width=0.92\textwidth,height=0.58\textheight,keepaspectratio]{images/tts/cs224s_compound_ai_pipeline.png}
  \captionof{figure}{Architecture of dialogue-state system for task-oriented dialogue (Williams et al., 2016)}
\end{frame}
...
%   \centering
%   \includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{images/tts/tts_deepfake_robocall_news.png}
...
%   \centering
%   \includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{images/tts/tts_voice_cloning_ethics_discussion.png}
