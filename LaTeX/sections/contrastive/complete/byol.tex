...
\end{figure}
{\footnotesize Source: Grill et al., ``Bootstrap Your Own Latent: A New Approach to Self-Supervised Learning,'' NeurIPS 2020, Fig.~2.}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{images/contrastive/slide_82_1_img.png}
\end{figure}
{\footnotesize Source: ResearchGate, ``BYOL neural architecture'' (\url{https://www.researchgate.net/figure/BYOL-neural-architecture_fig5_368988438}).}

\framebreak

\begin{figure}
    \centering
    \includegraphics[width=\linewidth,height=0.76\textheight,keepaspectratio]{images/contrastive/slide_83_1_img.jpg}
\end{figure}
{\footnotesize Source: Grill et al., ``Bootstrap Your Own Latent: A New Approach to Self-Supervised Learning,'' NeurIPS 2020, Fig.~1.}
...
\end{figure}
{\footnotesize Source: Grill et al., ``Bootstrap Your Own Latent: A New Approach to Self-Supervised Learning,'' NeurIPS 2020, Table~1.}
...
\end{figure}
{\footnotesize Source: Grill et al., ``Bootstrap Your Own Latent: A New Approach to Self-Supervised Learning,'' NeurIPS 2020, Table~3.}

\framebreak

\textbf{What's special about BYOL?}
\begin{itemize}
    \item Even though there are no explicit negatives, the asymmetry between the online and target networks (the predictor plus the slowly updated target) prevents collapse.
