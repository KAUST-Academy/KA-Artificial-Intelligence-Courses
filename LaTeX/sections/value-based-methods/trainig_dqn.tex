...
\begin{frame}{Training the Q-network: Experience Replay}
    \begin{itemize}
        ...
        \begin{itemize}
            \item Maintain a replay memory buffer of transitions $(s, a, r, s')$ as episodes are played.
        ...
        \end{itemize}
        \item Note: the replay buffer is a general off-policy tool---it is not specific to DQN.
    \end{itemize}
\end{frame}