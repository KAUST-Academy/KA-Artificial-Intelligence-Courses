...
\begin{frame}[allowframebreaks]{Pitfalls You Must Know Before Using Either}
    ...
    \begin{block}{}
        \centering
        \small \textbf{Exercise:} run SHAP (Tree and Kernel) and LIME on the same tabular model,
        with an explicit demonstration of instability under correlated features.
    \end{block}
