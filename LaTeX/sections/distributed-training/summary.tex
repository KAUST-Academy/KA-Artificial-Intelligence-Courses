...
\begin{frame}{The One Slide to Keep}
  \begin{itemize}\itemsep0.45em
    ...
    \item[\textcolor{red}{$\blacktriangleright$}] \textbf{Companion labs:} measure the 16-bytes-per-parameter rule on a real model, then repeat it under FSDP and compare the maximum batch size against DDP.
  \end{itemize}
\end{frame}
