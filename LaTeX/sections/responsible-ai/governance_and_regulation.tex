...
\begin{frame}{The EU AI Act: Risk Tiers}
    ...
    \begin{tikzpicture}
        ...
        \node[right, font=\scriptsize, text width=6.4cm, align=left] at (3.5,2.0)
            {\textbf{Prohibited (Art.~5), in part.} Social scoring; untargeted scraping of facial
             images to build recognition databases; emotion inference at work or school, except
             for medical or safety reasons; manipulative or exploitative systems.};
...
\begin{frame}[allowframebreaks]{The EU AI Act: What a High-Risk Provider Must Produce}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.46\textwidth}
            ...
            \begin{tcolorbox}[colback=raiRed!5, colframe=raiRed!70, title=Penalties (Article 99)]
                ...
                \textbf{EUR 7.5M or 1\%} for supplying incorrect information, in each case
                whichever is \emph{higher}. For SMEs and start-ups the same figures apply but the
                rule flips to whichever is \emph{lower}.
            \end{tcolorbox}
        \end{column}
    \end{columns}
    ...
    model obligations from 2 August 2025. Regulation (EU) 2026/1744 (the ``AI Omnibus,'' in force
    27 July 2026) deferred the high-risk obligations: Annex III to 2 December 2027, Annex I to
    2 August 2028, and softened Article 4 to a duty to \emph{support the development of} AI
    literacy. These dates have already moved once --- check the consolidated text.}
\end{frame}
...
\begin{frame}{NIST AI Risk Management Framework}
    ...
    \begin{columns}[c]
        ...
        \begin{column}{0.54\textwidth}
            ...
            management, where the AI Act tells you \emph{what} you must do. ISO/IEC 42001:2023,
            \emph{Information technology --- Artificial intelligence --- Management system}, plays
