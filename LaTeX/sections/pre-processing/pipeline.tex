\begin{frame}[allowframebreaks]{Pipelines}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.75\textwidth,keepaspectratio]{images/pre-processing/pipeline.png}
    \end{figure}
\end{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=0.72\textwidth,keepaspectratio]{images/pre-processing/pipeline_2.png}
\end{figure}
\end{frame}
