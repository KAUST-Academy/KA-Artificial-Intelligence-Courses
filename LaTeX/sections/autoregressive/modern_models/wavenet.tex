\begin{frame}[allowframebreaks]{WaveNet}
    ...
    \end{columns}
    \vspace{1em}
    {\scriptsize [Source: Abbeel, Chen, Ho, Srinivas, Li \& Yan, CS294-158 Deep Unsupervised Learning, UC Berkeley (Spring 2020), L2 Autoregressive Models, slide 43]}
    ...
    \end{columns}
    \vspace{1em}
    {\scriptsize [Source: Abbeel, Chen, Ho, Srinivas, Li \& Yan, CS294-158 Deep Unsupervised Learning, UC Berkeley (Spring 2020), L2 Autoregressive Models, slide 44]}
