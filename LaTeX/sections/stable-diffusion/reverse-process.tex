% --- Reverse process (from sections/diffusion/complete/reverse.tex) ---
...
\framebreak
    ...
    \begin{figure}
        \centering
        \includegraphics[height=0.3\textheight, width=\textwidth, keepaspectratio]{images/diffusion/diff_4.png}
