...
\begin{frame}{3 steps in constructing a tree}
    \begin{center}
        \includegraphics[width=0.70\linewidth,keepaspectratio]{images/decision-trees/decision-trees-9.png}
    \end{center}
...
\begin{frame}[allowframebreaks]{3 steps in constructing a tree}
    \begin{center}
        \includegraphics[width=0.85\linewidth,keepaspectratio]{images/decision-trees/decision-trees-9.png}
    \end{center}
\end{frame}
